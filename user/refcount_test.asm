...
void get_page(Page *p) {
  ...
  16:	9ee50513          	addi	a0,a0,-1554 # a00 <malloc+0x100>
  1a:	033000ef          	jal	84c <printf>
}
  1e:	60a2                	ld	ra,8(sp)
  20:	6402                	ld	s0,0(sp)
...
void put_page(Page *p) {
  ...
  40:	9ec50513          	addi	a0,a0,-1556 # a28 <malloc+0x128>
  44:	009000ef          	jal	84c <printf>
  ...
  5c:	a0050513          	addi	a0,a0,-1536 # a58 <malloc+0x158>
  60:	7ec000ef          	jal	84c <printf>
        free(p);
  64:	8526                	mv	a0,s1
  66:	019000ef          	jal	87e <free>
}
...
int main() {
  ...
  9c:	a5050513          	addi	a0,a0,-1456 # ae8 <malloc+0x1e8>
  ...
  a8:	a7c50513          	addi	a0,a0,-1412 # b20 <malloc+0x220>
  ac:	7a0000ef          	jal	84c <printf>
    printf("[Process A] "); get_page(shared_page);
  b0:	00001517          	auipc	a0,0x1
  b4:	a9050513          	addi	a0,a0,-1392 # b40 <malloc+0x240>
  b8:	794000ef          	jal	84c <printf>
  bc:	8526                	mv	a0,s1
  be:	f43ff0ef          	jal	0 <get_page>
    printf("[Process B] "); get_page(shared_page);
  c2:	00001517          	auipc	a0,0x1
  c6:	a8e50513          	addi	a0,a0,-1394 # b50 <malloc+0x250>
  ca:	782000ef          	jal	84c <printf>
  ce:	8526                	mv	a0,s1
  d0:	f31ff0ef          	jal	0 <get_page>
    printf("[Process C] "); get_page(shared_page);
  d4:	00001517          	auipc	a0,0x1
  d8:	a8c50513          	addi	a0,a0,-1396 # b60 <malloc+0x260>
  dc:	770000ef          	jal	84c <printf>
  e0:	8526                	mv	a0,s1
  ...
  ea:	a8a50513          	addi	a0,a0,-1398 # b70 <malloc+0x270>
  ee:	75e000ef          	jal	84c <printf>
    printf("[Process A] "); put_page(shared_page);
  f2:	00001517          	auipc	a0,0x1
  f6:	a4e50513          	addi	a0,a0,-1458 # b40 <malloc+0x240>
  fa:	752000ef          	jal	84c <printf>
  fe:	8526                	mv	a0,s1
 100:	f27ff0ef          	jal	26 <put_page>
    printf("[Process B] "); put_page(shared_page);
 104:	00001517          	auipc	a0,0x1
 108:	a4c50513          	addi	a0,a0,-1460 # b50 <malloc+0x250>
 10c:	740000ef          	jal	84c <printf>
 110:	8526                	mv	a0,s1
 ...
 11c:	a7850513          	addi	a0,a0,-1416 # b90 <malloc+0x290>
 120:	72c000ef          	jal	84c <printf>
    
    printf("[Process C] "); put_page(shared_page);
 124:	00001517          	auipc	a0,0x1
 128:	a3c50513          	addi	a0,a0,-1476 # b60 <malloc+0x260>
 12c:	720000ef          	jal	84c <printf>
 130:	8526                	mv	a0,s1
 ...
 142:	98a50513          	addi	a0,a0,-1654 # ac8 <malloc+0x1c8>
 146:	706000ef          	jal	84c <printf>
        exit(1);
 14a:	4505                	li	a0,1
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 500:	6e450513          	addi	a0,a0,1764 # be0 <digits>
 504:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7f8:	3e490913          	addi	s2,s2,996 # bd8 <malloc+0x2d8>
        for(; *s; s++)
