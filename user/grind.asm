...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      8e:	10650513          	addi	a0,a0,262 # 1190 <malloc+0x102>
      92:	349000ef          	jal	bda <mkdir>
  if(chdir("grindir") != 0){
      96:	00001517          	auipc	a0,0x1
      9a:	0fa50513          	addi	a0,a0,250 # 1190 <malloc+0x102>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      b0:	0ec50513          	addi	a0,a0,236 # 1198 <malloc+0x10a>
      b4:	727000ef          	jal	fda <printf>
    exit(1);
      b8:	4505                	li	a0,1
  ...
  chdir("/");
      ...
      ca:	0fa50513          	addi	a0,a0,250 # 11c0 <malloc+0x132>
      ce:	315000ef          	jal	be2 <chdir>
      d2:	00001997          	auipc	s3,0x1
      d6:	0fe98993          	addi	s3,s3,254 # 11d0 <malloc+0x142>
      da:	c489                	beqz	s1,e4 <go+0x70>
      dc:	00001997          	auipc	s3,0x1
      e0:	0ec98993          	addi	s3,s3,236 # 11c8 <malloc+0x13a>
  uint64 iters = 0;
      e4:	4481                	li	s1,0
  int fd = -1;
      e6:	5a7d                	li	s4,-1
      e8:	00001917          	auipc	s2,0x1
      ec:	3b890913          	addi	s2,s2,952 # 14a0 <malloc+0x412>
    ...
    if(what == 1){
      ...
      fa:	0e250513          	addi	a0,a0,226 # 11d8 <malloc+0x14a>
    ...
    int what = rand() % 23;
     ...
     148:	0a450513          	addi	a0,a0,164 # 11e8 <malloc+0x15a>
     ...
     15a:	08250513          	addi	a0,a0,130 # 11d8 <malloc+0x14a>
     15e:	265000ef          	jal	bc2 <unlink>
     162:	b755                	j	106 <go+0x92>
    } else if(what == 4){
      if(chdir("grindir") != 0){
     164:	00001517          	auipc	a0,0x1
     168:	02c50513          	addi	a0,a0,44 # 1190 <malloc+0x102>
     ...
     176:	08e50513          	addi	a0,a0,142 # 1200 <malloc+0x172>
     17a:	249000ef          	jal	bc2 <unlink>
      chdir("/");
     17e:	00001517          	auipc	a0,0x1
     182:	04250513          	addi	a0,a0,66 # 11c0 <malloc+0x132>
     186:	25d000ef          	jal	be2 <chdir>
     18a:	bfb5                	j	106 <go+0x92>
        printf("grind: chdir grindir failed\n");
     18c:	00001517          	auipc	a0,0x1
     190:	00c50513          	addi	a0,a0,12 # 1198 <malloc+0x10a>
     194:	647000ef          	jal	fda <printf>
        exit(1);
     198:	4505                	li	a0,1
     ...
     1ac:	06050513          	addi	a0,a0,96 # 1208 <malloc+0x17a>
     ...
     1c6:	05650513          	addi	a0,a0,86 # 1218 <malloc+0x18a>
     ...
     2b4:	ff050513          	addi	a0,a0,-16 # 12a0 <malloc+0x212>
     2b8:	523000ef          	jal	fda <printf>
        exit(1);
     2bc:	4505                	li	a0,1
     ...
     2e6:	fbe50513          	addi	a0,a0,-66 # 12a0 <malloc+0x212>
     2ea:	4f1000ef          	jal	fda <printf>
        exit(1);
     2ee:	4505                	li	a0,1
     2f0:	083000ef          	jal	b72 <exit>
      ...
      sbrk(6011);
     2f4:	6505                	lui	a0,0x1
     2f6:	77b50513          	addi	a0,a0,1915 # 177b <digits+0x27b>
     ...
     32a:	f9a50513          	addi	a0,a0,-102 # 12c0 <malloc+0x232>
     ...
     34a:	f7250513          	addi	a0,a0,-142 # 12b8 <malloc+0x22a>
     ...
     360:	f4450513          	addi	a0,a0,-188 # 12a0 <malloc+0x212>
     364:	477000ef          	jal	fda <printf>
        exit(1);
     368:	4505                	li	a0,1
     36a:	009000ef          	jal	b72 <exit>
        printf("grind: chdir failed\n");
     36e:	00001517          	auipc	a0,0x1
     372:	f6250513          	addi	a0,a0,-158 # 12d0 <malloc+0x242>
     376:	465000ef          	jal	fda <printf>
        exit(1);
     37a:	4505                	li	a0,1
     ...
     3a4:	f0050513          	addi	a0,a0,-256 # 12a0 <malloc+0x212>
     3a8:	433000ef          	jal	fda <printf>
        exit(1);
     3ac:	4505                	li	a0,1
     ...
     3e4:	f0850513          	addi	a0,a0,-248 # 12e8 <malloc+0x25a>
     3e8:	3f3000ef          	jal	fda <printf>
        exit(1);
     3ec:	4505                	li	a0,1
     ...
     400:	f0458593          	addi	a1,a1,-252 # 1300 <malloc+0x272>
     ...
     430:	edc50513          	addi	a0,a0,-292 # 1308 <malloc+0x27a>
     434:	3a7000ef          	jal	fda <printf>
     438:	bfe9                	j	412 <go+0x39e>
          printf("grind: pipe read failed\n");
     43a:	00001517          	auipc	a0,0x1
     43e:	eee50513          	addi	a0,a0,-274 # 1328 <malloc+0x29a>
     442:	399000ef          	jal	fda <printf>
     446:	b7c5                	j	426 <go+0x3b2>
        printf("grind: fork failed\n");
     448:	00001517          	auipc	a0,0x1
     44c:	e5850513          	addi	a0,a0,-424 # 12a0 <malloc+0x212>
     450:	38b000ef          	jal	fda <printf>
        exit(1);
     454:	4505                	li	a0,1
     ...
     4c2:	de250513          	addi	a0,a0,-542 # 12a0 <malloc+0x212>
     4c6:	315000ef          	jal	fda <printf>
        exit(1);
     4ca:	4505                	li	a0,1
     ...
     4d4:	e8050513          	addi	a0,a0,-384 # 1350 <malloc+0x2c2>
     ...
     4e4:	e7050513          	addi	a0,a0,-400 # 1350 <malloc+0x2c2>
     ...
     4f8:	e0c58593          	addi	a1,a1,-500 # 1300 <malloc+0x272>
     ...
     532:	e2250513          	addi	a0,a0,-478 # 1350 <malloc+0x2c2>
     536:	68c000ef          	jal	bc2 <unlink>
     53a:	b6f1                	j	106 <go+0x92>
        printf("grind: create c failed\n");
     53c:	00001517          	auipc	a0,0x1
     540:	e1c50513          	addi	a0,a0,-484 # 1358 <malloc+0x2ca>
     544:	297000ef          	jal	fda <printf>
        exit(1);
     548:	4505                	li	a0,1
     54a:	628000ef          	jal	b72 <exit>
        printf("grind: write c failed\n");
     54e:	00001517          	auipc	a0,0x1
     552:	e2250513          	addi	a0,a0,-478 # 1370 <malloc+0x2e2>
     556:	285000ef          	jal	fda <printf>
        exit(1);
     55a:	4505                	li	a0,1
     55c:	616000ef          	jal	b72 <exit>
        printf("grind: fstat failed\n");
     560:	00001517          	auipc	a0,0x1
     564:	e2850513          	addi	a0,a0,-472 # 1388 <malloc+0x2fa>
     568:	273000ef          	jal	fda <printf>
        exit(1);
     56c:	4505                	li	a0,1
     ...
     578:	e2c50513          	addi	a0,a0,-468 # 13a0 <malloc+0x312>
     57c:	25f000ef          	jal	fda <printf>
        exit(1);
     580:	4505                	li	a0,1
     582:	5f0000ef          	jal	b72 <exit>
        printf("grind: fstat reports crazy i-number %d\n", st.ino);
     586:	00001517          	auipc	a0,0x1
     58a:	e4250513          	addi	a0,a0,-446 # 13c8 <malloc+0x33a>
     58e:	24d000ef          	jal	fda <printf>
        exit(1);
     592:	4505                	li	a0,1
     ...
     636:	e3658593          	addi	a1,a1,-458 # 1468 <malloc+0x3da>
     ...
     656:	e1e50513          	addi	a0,a0,-482 # 1470 <malloc+0x3e2>
     65a:	181000ef          	jal	fda <printf>
        exit(1);
     65e:	4505                	li	a0,1
     660:	512000ef          	jal	b72 <exit>
        fprintf(2, "grind: pipe failed\n");
     664:	00001597          	auipc	a1,0x1
     668:	c8458593          	addi	a1,a1,-892 # 12e8 <malloc+0x25a>
     66c:	4509                	li	a0,2
     66e:	143000ef          	jal	fb0 <fprintf>
        exit(1);
     672:	4505                	li	a0,1
     674:	4fe000ef          	jal	b72 <exit>
        fprintf(2, "grind: pipe failed\n");
     678:	00001597          	auipc	a1,0x1
     67c:	c7058593          	addi	a1,a1,-912 # 12e8 <malloc+0x25a>
     680:	4509                	li	a0,2
     682:	12f000ef          	jal	fb0 <fprintf>
        exit(1);
     686:	4505                	li	a0,1
     ...
     6bc:	d3858593          	addi	a1,a1,-712 # 13f0 <malloc+0x362>
     6c0:	4509                	li	a0,2
     6c2:	0ef000ef          	jal	fb0 <fprintf>
          exit(1);
     6c6:	4505                	li	a0,1
     ...
     6d8:	d3478793          	addi	a5,a5,-716 # 1408 <malloc+0x37a>
     6dc:	faf43423          	sd	a5,-88(s0)
     6e0:	00001797          	auipc	a5,0x1
     6e4:	d3078793          	addi	a5,a5,-720 # 1410 <malloc+0x382>
     6e8:	faf43823          	sd	a5,-80(s0)
     6ec:	fa043c23          	sd	zero,-72(s0)
        exec("grindir/../echo", args);
     6f0:	fa840593          	addi	a1,s0,-88
     6f4:	00001517          	auipc	a0,0x1
     6f8:	d2450513          	addi	a0,a0,-732 # 1418 <malloc+0x38a>
     6fc:	4ae000ef          	jal	baa <exec>
        fprintf(2, "grind: echo: not found\n");
     700:	00001597          	auipc	a1,0x1
     704:	d2858593          	addi	a1,a1,-728 # 1428 <malloc+0x39a>
     708:	4509                	li	a0,2
     70a:	0a7000ef          	jal	fb0 <fprintf>
        exit(2);
     70e:	4509                	li	a0,2
     710:	462000ef          	jal	b72 <exit>
        fprintf(2, "grind: fork failed\n");
     714:	00001597          	auipc	a1,0x1
     718:	b8c58593          	addi	a1,a1,-1140 # 12a0 <malloc+0x212>
     71c:	4509                	li	a0,2
     71e:	093000ef          	jal	fb0 <fprintf>
        exit(3);
     722:	450d                	li	a0,3
     ...
     74c:	ca858593          	addi	a1,a1,-856 # 13f0 <malloc+0x362>
     750:	4509                	li	a0,2
     752:	05f000ef          	jal	fb0 <fprintf>
          exit(4);
     756:	4511                	li	a0,4
     ...
     77c:	c7858593          	addi	a1,a1,-904 # 13f0 <malloc+0x362>
     780:	4509                	li	a0,2
     782:	02f000ef          	jal	fb0 <fprintf>
          exit(5);
     786:	4515                	li	a0,5
     ...
     798:	cac78793          	addi	a5,a5,-852 # 1440 <malloc+0x3b2>
     79c:	faf43423          	sd	a5,-88(s0)
     7a0:	fa043823          	sd	zero,-80(s0)
        exec("/cat", args);
     7a4:	fa840593          	addi	a1,s0,-88
     7a8:	00001517          	auipc	a0,0x1
     7ac:	ca050513          	addi	a0,a0,-864 # 1448 <malloc+0x3ba>
     7b0:	3fa000ef          	jal	baa <exec>
        fprintf(2, "grind: cat: not found\n");
     7b4:	00001597          	auipc	a1,0x1
     7b8:	c9c58593          	addi	a1,a1,-868 # 1450 <malloc+0x3c2>
     7bc:	4509                	li	a0,2
     7be:	7f2000ef          	jal	fb0 <fprintf>
        exit(6);
     7c2:	4519                	li	a0,6
     7c4:	3ae000ef          	jal	b72 <exit>
        fprintf(2, "grind: fork failed\n");
     7c8:	00001597          	auipc	a1,0x1
     7cc:	ad858593          	addi	a1,a1,-1320 # 12a0 <malloc+0x212>
     7d0:	4509                	li	a0,2
     7d2:	7de000ef          	jal	fb0 <fprintf>
        exit(7);
     7d6:	451d                	li	a0,7
...
iter()
{
  ...
  unlink("a");
     ...
     7e8:	ad450513          	addi	a0,a0,-1324 # 12b8 <malloc+0x22a>
     7ec:	3d6000ef          	jal	bc2 <unlink>
  unlink("b");
     7f0:	00001517          	auipc	a0,0x1
     7f4:	a7850513          	addi	a0,a0,-1416 # 1268 <malloc+0x1da>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     82a:	a7a50513          	addi	a0,a0,-1414 # 12a0 <malloc+0x212>
     82e:	7ac000ef          	jal	fda <printf>
    exit(1);
     832:	4505                	li	a0,1
  ...
  if(pid2 == 0){
    ...
    rand_next ^= 7177;
     ...
     84e:	629c                	ld	a5,0(a3)
     850:	6709                	lui	a4,0x2
     852:	c0970713          	addi	a4,a4,-1015 # 1c09 <digits+0x709>
    ...
    printf("grind: fork failed\n");
     ...
     864:	a4050513          	addi	a0,a0,-1472 # 12a0 <malloc+0x212>
     868:	772000ef          	jal	fda <printf>
    exit(1);
     86c:	4505                	li	a0,1
...
putc(int fd, char c)
{
     ...
     c5a:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     c5e:	4605                	li	a2,1
     c60:	fef40593          	addi	a1,s0,-17
     c64:	f2fff0ef          	jal	b92 <write>
}
     c68:	60e2                	ld	ra,24(sp)
     c6a:	6442                	ld	s0,16(sp)
     c6c:	6105                	addi	sp,sp,32
     c6e:	8082                	ret

0000000000000c70 <printint>:
...
printint(int fd, long long xx, int base, int sgn)
{
     ...
     c76:	f84a                	sd	s2,48(sp)
     c78:	0880                	addi	s0,sp,80
     c7a:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     c7c:	c299                	beqz	a3,c82 <printint+0x12>
     c7e:	0805c363          	bltz	a1,d04 <printint+0x94>
  neg = 0;
     c82:	4881                	li	a7,0
     c84:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     c8e:	87650513          	addi	a0,a0,-1930 # 1500 <digits>
     c92:	883e                	mv	a6,a5
     c94:	2785                	addiw	a5,a5,1
     c96:	02c5f733          	remu	a4,a1,a2
     c9a:	972a                	add	a4,a4,a0
     c9c:	00074703          	lbu	a4,0(a4)
     ca0:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
     ca4:	872e                	mv	a4,a1
     ca6:	02c5d5b3          	divu	a1,a1,a2
     caa:	0685                	addi	a3,a3,1
     cac:	fec773e3          	bgeu	a4,a2,c92 <printint+0x22>
  if(neg)
     cb0:	00088b63          	beqz	a7,cc6 <printint+0x56>
    buf[i++] = '-';
     cb4:	fd078793          	addi	a5,a5,-48
     cb8:	97a2                	add	a5,a5,s0
     cba:	02d00713          	li	a4,45
     cbe:	fee78423          	sb	a4,-24(a5)
     cc2:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     cc6:	02f05a63          	blez	a5,cfa <printint+0x8a>
     cca:	fc26                	sd	s1,56(sp)
     ccc:	f44e                	sd	s3,40(sp)
     cce:	fb840713          	addi	a4,s0,-72
     cd2:	00f704b3          	add	s1,a4,a5
     cd6:	fff70993          	addi	s3,a4,-1
     cda:	99be                	add	s3,s3,a5
     cdc:	37fd                	addiw	a5,a5,-1
     cde:	1782                	slli	a5,a5,0x20
     ce0:	9381                	srli	a5,a5,0x20
     ce2:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     ce6:	fff4c583          	lbu	a1,-1(s1)
     cea:	854a                	mv	a0,s2
     cec:	f67ff0ef          	jal	c52 <putc>
  while(--i >= 0)
     cf0:	14fd                	addi	s1,s1,-1
     cf2:	ff349ae3          	bne	s1,s3,ce6 <printint+0x76>
     cf6:	74e2                	ld	s1,56(sp)
     cf8:	79a2                	ld	s3,40(sp)
}
     cfa:	60a6                	ld	ra,72(sp)
     cfc:	6406                	ld	s0,64(sp)
     cfe:	7942                	ld	s2,48(sp)
    ...
    neg = 1;
     d08:	4885                	li	a7,1
    x = -xx;
     d0a:	bfad                	j	c84 <printint+0x14>

0000000000000d0c <vprintf>:
}
...
vprintf(int fd, const char *fmt, va_list ap)
{
     ...
     d0e:	ec86                	sd	ra,88(sp)
     d10:	e8a2                	sd	s0,80(sp)
     d12:	e0ca                	sd	s2,64(sp)
  ...
  state = 0;
  for(i = 0; fmt[i]; i++){
     d16:	0005c903          	lbu	s2,0(a1)
     d1a:	28090663          	beqz	s2,fa6 <vprintf+0x29a>
     d1e:	e4a6                	sd	s1,72(sp)
     d20:	fc4e                	sd	s3,56(sp)
     d22:	f852                	sd	s4,48(sp)
     d24:	f456                	sd	s5,40(sp)
     d26:	f05a                	sd	s6,32(sp)
     d28:	ec5e                	sd	s7,24(sp)
     d2a:	e862                	sd	s8,16(sp)
     d2c:	e466                	sd	s9,8(sp)
     d2e:	8b2a                	mv	s6,a0
     d30:	8a2e                	mv	s4,a1
     d32:	8bb2                	mv	s7,a2
  ...
  for(i = 0; fmt[i]; i++){
     ...
     d42:	06c00c93          	li	s9,108
     d46:	a005                	j	d66 <vprintf+0x5a>
        putc(fd, c0);
     d48:	85ca                	mv	a1,s2
     d4a:	855a                	mv	a0,s6
     d4c:	f07ff0ef          	jal	c52 <putc>
     d50:	a019                	j	d56 <vprintf+0x4a>
    } else if(state == '%'){
     d52:	03598263          	beq	s3,s5,d76 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
     d56:	2485                	addiw	s1,s1,1
     d58:	8726                	mv	a4,s1
     d5a:	009a07b3          	add	a5,s4,s1
     d5e:	0007c903          	lbu	s2,0(a5)
     d62:	22090a63          	beqz	s2,f96 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
     d66:	0009079b          	sext.w	a5,s2
    if(state == 0){
     d6a:	fe0994e3          	bnez	s3,d52 <vprintf+0x46>
      if(c0 == '%'){
     d6e:	fd579de3          	bne	a5,s5,d48 <vprintf+0x3c>
        state = '%';
     d72:	89be                	mv	s3,a5
     d74:	b7cd                	j	d56 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
     ...
     d7e:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
     d80:	c681                	beqz	a3,d88 <vprintf+0x7c>
     d82:	9752                	add	a4,a4,s4
     d84:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     d88:	05878363          	beq	a5,s8,dce <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     d8c:	05978d63          	beq	a5,s9,de6 <vprintf+0xda>
     ...
     d90:	07500713          	li	a4,117
     d94:	0ee78763          	beq	a5,a4,e82 <vprintf+0x176>
     ...
     d98:	07800713          	li	a4,120
     d9c:	12e78963          	beq	a5,a4,ece <vprintf+0x1c2>
     ...
     da0:	07000713          	li	a4,112
     da4:	14e78e63          	beq	a5,a4,f00 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     da8:	06300713          	li	a4,99
     dac:	18e78e63          	beq	a5,a4,f48 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     db0:	07300713          	li	a4,115
     db4:	1ae78463          	beq	a5,a4,f5c <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
     db8:	02500713          	li	a4,37
     dbc:	04e79563          	bne	a5,a4,e06 <vprintf+0xfa>
        putc(fd, '%');
     dc0:	02500593          	li	a1,37
     dc4:	855a                	mv	a0,s6
     dc6:	e8dff0ef          	jal	c52 <putc>
      ...
      state = 0;
     dca:	4981                	li	s3,0
     dcc:	b769                	j	d56 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
     dce:	008b8913          	addi	s2,s7,8
     dd2:	4685                	li	a3,1
     dd4:	4629                	li	a2,10
     dd6:	000ba583          	lw	a1,0(s7)
     dda:	855a                	mv	a0,s6
     ddc:	e95ff0ef          	jal	c70 <printint>
     de0:	8bca                	mv	s7,s2
      state = 0;
     de2:	4981                	li	s3,0
     de4:	bf8d                	j	d56 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     de6:	06400793          	li	a5,100
     dea:	02f68963          	beq	a3,a5,e1c <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     dee:	06c00793          	li	a5,108
     df2:	04f68263          	beq	a3,a5,e36 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     df6:	07500793          	li	a5,117
     dfa:	0af68063          	beq	a3,a5,e9a <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     dfe:	07800793          	li	a5,120
     e02:	0ef68263          	beq	a3,a5,ee6 <vprintf+0x1da>
        putc(fd, '%');
     e06:	02500593          	li	a1,37
     e0a:	855a                	mv	a0,s6
     e0c:	e47ff0ef          	jal	c52 <putc>
        putc(fd, c0);
     e10:	85ca                	mv	a1,s2
     e12:	855a                	mv	a0,s6
     e14:	e3fff0ef          	jal	c52 <putc>
      state = 0;
     e18:	4981                	li	s3,0
     e1a:	bf35                	j	d56 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     e32:	4981                	li	s3,0
        i += 1;
     e34:	b70d                	j	d56 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     e36:	06400793          	li	a5,100
     e3a:	02f60763          	beq	a2,a5,e68 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     e3e:	07500793          	li	a5,117
     e42:	06f60963          	beq	a2,a5,eb4 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     e46:	07800793          	li	a5,120
     e4a:	faf61ee3          	bne	a2,a5,e06 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     e5a:	855a                	mv	a0,s6
     e5c:	e15ff0ef          	jal	c70 <printint>
        i += 2;
     e60:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
     e62:	8bca                	mv	s7,s2
      state = 0;
     e64:	4981                	li	s3,0
        i += 2;
     e66:	bdc5                	j	d56 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     e8e:	855a                	mv	a0,s6
     e90:	de1ff0ef          	jal	c70 <printint>
     e94:	8bca                	mv	s7,s2
      state = 0;
     e96:	4981                	li	s3,0
     e98:	bd7d                	j	d56 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     eca:	4981                	li	s3,0
        i += 2;
     ecc:	b569                	j	d56 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
     ece:	008b8913          	addi	s2,s7,8
     ed2:	4681                	li	a3,0
     ed4:	4641                	li	a2,16
     ed6:	000be583          	lwu	a1,0(s7)
     eda:	855a                	mv	a0,s6
     edc:	d95ff0ef          	jal	c70 <printint>
     ee0:	8bca                	mv	s7,s2
      state = 0;
     ee2:	4981                	li	s3,0
     ee4:	bd8d                	j	d56 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     efc:	4981                	li	s3,0
        i += 1;
     efe:	bda1                	j	d56 <vprintf+0x4a>
     f00:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
     f02:	008b8d13          	addi	s10,s7,8
     f06:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     f0a:	03000593          	li	a1,48
     f0e:	855a                	mv	a0,s6
     f10:	d43ff0ef          	jal	c52 <putc>
  putc(fd, 'x');
     f14:	07800593          	li	a1,120
     f18:	855a                	mv	a0,s6
     f1a:	d39ff0ef          	jal	c52 <putc>
     f1e:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     f20:	00000b97          	auipc	s7,0x0
     f24:	5e0b8b93          	addi	s7,s7,1504 # 1500 <digits>
     f28:	03c9d793          	srli	a5,s3,0x3c
     f2c:	97de                	add	a5,a5,s7
     f2e:	0007c583          	lbu	a1,0(a5)
     f32:	855a                	mv	a0,s6
     f34:	d1fff0ef          	jal	c52 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     f38:	0992                	slli	s3,s3,0x4
     f3a:	397d                	addiw	s2,s2,-1
     f3c:	fe0916e3          	bnez	s2,f28 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
     f40:	8bea                	mv	s7,s10
      state = 0;
     f42:	4981                	li	s3,0
     f44:	6d02                	ld	s10,0(sp)
     f46:	bd01                	j	d56 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
     f48:	008b8913          	addi	s2,s7,8
     f4c:	000bc583          	lbu	a1,0(s7)
     f50:	855a                	mv	a0,s6
     f52:	d01ff0ef          	jal	c52 <putc>
     f56:	8bca                	mv	s7,s2
      state = 0;
     f58:	4981                	li	s3,0
     f5a:	bbf5                	j	d56 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
     f5c:	008b8993          	addi	s3,s7,8
     f60:	000bb903          	ld	s2,0(s7)
     f64:	00090f63          	beqz	s2,f82 <vprintf+0x276>
        for(; *s; s++)
     f68:	00094583          	lbu	a1,0(s2)
     f6c:	c195                	beqz	a1,f90 <vprintf+0x284>
          putc(fd, *s);
     f6e:	855a                	mv	a0,s6
     f70:	ce3ff0ef          	jal	c52 <putc>
        for(; *s; s++)
     f74:	0905                	addi	s2,s2,1
     f76:	00094583          	lbu	a1,0(s2)
     f7a:	f9f5                	bnez	a1,f6e <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
     f7c:	8bce                	mv	s7,s3
      state = 0;
     f7e:	4981                	li	s3,0
     f80:	bbd9                	j	d56 <vprintf+0x4a>
          s = "(null)";
     f82:	00000917          	auipc	s2,0x0
     f86:	51690913          	addi	s2,s2,1302 # 1498 <malloc+0x40a>
        for(; *s; s++)
     f8a:	02800593          	li	a1,40
     f8e:	b7c5                	j	f6e <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
     f90:	8bce                	mv	s7,s3
      state = 0;
     f92:	4981                	li	s3,0
     f94:	b3c9                	j	d56 <vprintf+0x4a>
     f96:	64a6                	ld	s1,72(sp)
     f98:	79e2                	ld	s3,56(sp)
     f9a:	7a42                	ld	s4,48(sp)
     f9c:	7aa2                	ld	s5,40(sp)
     f9e:	7b02                	ld	s6,32(sp)
     fa0:	6be2                	ld	s7,24(sp)
     fa2:	6c42                	ld	s8,16(sp)
     fa4:	6ca2                	ld	s9,8(sp)
    }
  }
}
     fa6:	60e6                	ld	ra,88(sp)
     fa8:	6446                	ld	s0,80(sp)
     faa:	6906                	ld	s2,64(sp)
...
0000000000000fda <printf>:

void
printf(const char *fmt, ...)
{
     fda:	711d                	addi	sp,sp,-96
     fdc:	ec06                	sd	ra,24(sp)
     fde:	e822                	sd	s0,16(sp)
     fe0:	1000                	addi	s0,sp,32
     fe2:	e40c                	sd	a1,8(s0)
     fe4:	e810                	sd	a2,16(s0)
     fe6:	ec14                	sd	a3,24(s0)
     fe8:	f018                	sd	a4,32(s0)
     fea:	f41c                	sd	a5,40(s0)
     fec:	03043823          	sd	a6,48(s0)
     ff0:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
     ff4:	00840613          	addi	a2,s0,8
     ff8:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
     ffc:	85aa                	mv	a1,a0
     ffe:	4505                	li	a0,1
    1000:	d0dff0ef          	jal	d0c <vprintf>
}
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    101a:	ffa7b783          	ld	a5,-6(a5) # 2010 <freep>
    101e:	a02d                	j	1048 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    1020:	4618                	lw	a4,8(a2)
    1022:	9f2d                	addw	a4,a4,a1
    1024:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    1028:	6398                	ld	a4,0(a5)
    102a:	6310                	ld	a2,0(a4)
    102c:	a83d                	j	106a <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    102e:	ff852703          	lw	a4,-8(a0)
    1032:	9f31                	addw	a4,a4,a2
    1034:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    1036:	ff053683          	ld	a3,-16(a0)
    103a:	a091                	j	107e <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    103c:	6398                	ld	a4,0(a5)
    103e:	00e7e463          	bltu	a5,a4,1046 <free+0x3a>
    1042:	00e6ea63          	bltu	a3,a4,1056 <free+0x4a>
{
    1046:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1048:	fed7fae3          	bgeu	a5,a3,103c <free+0x30>
    104c:	6398                	ld	a4,0(a5)
    104e:	00e6e463          	bltu	a3,a4,1056 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    1052:	fee7eae3          	bltu	a5,a4,1046 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1056:	ff852583          	lw	a1,-8(a0)
    105a:	6390                	ld	a2,0(a5)
    105c:	02059813          	slli	a6,a1,0x20
    1060:	01c85713          	srli	a4,a6,0x1c
    1064:	9736                	add	a4,a4,a3
    1066:	fae60de3          	beq	a2,a4,1020 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    106a:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    106e:	4790                	lw	a2,8(a5)
    1070:	02061593          	slli	a1,a2,0x20
    1074:	01c5d713          	srli	a4,a1,0x1c
    1078:	973e                	add	a4,a4,a5
    107a:	fae68ae3          	beq	a3,a4,102e <free+0x22>
    p->s.ptr = bp->s.ptr;
    107e:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    1080:	00001717          	auipc	a4,0x1
    1084:	f8f73823          	sd	a5,-112(a4) # 2010 <freep>
}
    1088:	6422                	ld	s0,8(sp)
    108a:	0141                	addi	sp,sp,16
    108c:	8082                	ret

000000000000108e <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    108e:	7139                	addi	sp,sp,-64
    1090:	fc06                	sd	ra,56(sp)
    1092:	f822                	sd	s0,48(sp)
    1094:	f426                	sd	s1,40(sp)
    1096:	ec4e                	sd	s3,24(sp)
    1098:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    109a:	02051493          	slli	s1,a0,0x20
    109e:	9081                	srli	s1,s1,0x20
    10a0:	04bd                	addi	s1,s1,15
    10a2:	8091                	srli	s1,s1,0x4
    10a4:	0014899b          	addiw	s3,s1,1
    10a8:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    10aa:	00001517          	auipc	a0,0x1
    10ae:	f6653503          	ld	a0,-154(a0) # 2010 <freep>
    10b2:	c915                	beqz	a0,10e6 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    10b4:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    10b6:	4798                	lw	a4,8(a5)
    10b8:	08977a63          	bgeu	a4,s1,114c <malloc+0xbe>
  ...
  if(nu < 4096)
    10c4:	8a4e                	mv	s4,s3
    10c6:	0009871b          	sext.w	a4,s3
    10ca:	6685                	lui	a3,0x1
    10cc:	00d77363          	bgeu	a4,a3,10d2 <malloc+0x44>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    if(p == freep)
    10da:	00001917          	auipc	s2,0x1
    10de:	f3690913          	addi	s2,s2,-202 # 2010 <freep>
  if(p == SBRK_ERROR)
    10e2:	5afd                	li	s5,-1
    10e4:	a081                	j	1124 <malloc+0x96>
    ...
    10f2:	31a78793          	addi	a5,a5,794 # 2408 <base>
    ...
    if(p->s.size >= nunits){
    1104:	b7c1                	j	10c4 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    1106:	6398                	ld	a4,0(a5)
    1108:	e118                	sd	a4,0(a0)
    110a:	a8a9                	j	1164 <malloc+0xd6>
  hp->s.size = nu;
    110c:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    1110:	0541                	addi	a0,a0,16
    1112:	efbff0ef          	jal	100c <free>
  return freep;
    1116:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    111a:	c12d                	beqz	a0,117c <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    111c:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    111e:	4798                	lw	a4,8(a5)
    1120:	02977263          	bgeu	a4,s1,1144 <malloc+0xb6>
    if(p == freep)
    1124:	00093703          	ld	a4,0(s2)
    1128:	853e                	mv	a0,a5
    112a:	fef719e3          	bne	a4,a5,111c <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    112e:	8552                	mv	a0,s4
    1130:	a0fff0ef          	jal	b3e <sbrk>
  if(p == SBRK_ERROR)
    1134:	fd551ce3          	bne	a0,s5,110c <malloc+0x7e>
        return 0;
    1138:	4501                	li	a0,0
    ...
    1142:	a03d                	j	1170 <malloc+0xe2>
    1144:	7902                	ld	s2,32(sp)
    1146:	6a42                	ld	s4,16(sp)
    1148:	6aa2                	ld	s5,8(sp)
    114a:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    114c:	fae48de3          	beq	s1,a4,1106 <malloc+0x78>
        p->s.size -= nunits;
    1150:	4137073b          	subw	a4,a4,s3
    1154:	c798                	sw	a4,8(a5)
        p += p->s.size;
    1156:	02071693          	slli	a3,a4,0x20
    115a:	01c6d713          	srli	a4,a3,0x1c
    115e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    1160:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    1164:	00001717          	auipc	a4,0x1
    1168:	eaa73623          	sd	a0,-340(a4) # 2010 <freep>
      return (void*)(p + 1);
    116c:	01078513          	addi	a0,a5,16
  }
}
    1170:	70e2                	ld	ra,56(sp)
    1172:	7442                	ld	s0,48(sp)
    1174:	74a2                	ld	s1,40(sp)
    1176:	69e2                	ld	s3,24(sp)
    1178:	6121                	addi	sp,sp,64
    117a:	8082                	ret
    117c:	7902                	ld	s2,32(sp)
    117e:	6a42                	ld	s4,16(sp)
    1180:	6aa2                	ld	s5,8(sp)
    1182:	6b02                	ld	s6,0(sp)
    1184:	b7f5                	j	1170 <malloc+0xe2>
