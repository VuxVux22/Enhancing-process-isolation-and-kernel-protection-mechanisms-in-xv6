...
main(void)
{
  ...
  12:	96250513          	addi	a0,a0,-1694 # 970 <malloc+0x104>
  ...
  2e:	94e90913          	addi	s2,s2,-1714 # 978 <malloc+0x10c>
  32:	854a                	mv	a0,s2
  ...
  56:	97650513          	addi	a0,a0,-1674 # 9c8 <malloc+0x15c>
  ...
  6c:	90850513          	addi	a0,a0,-1784 # 970 <malloc+0x104>
  70:	328000ef          	jal	398 <mknod>
    open("console", O_RDWR);
  74:	4589                	li	a1,2
  76:	00001517          	auipc	a0,0x1
  7a:	8fa50513          	addi	a0,a0,-1798 # 970 <malloc+0x104>
  7e:	312000ef          	jal	390 <open>
  82:	bf71                	j	1e <main+0x1e>
      printf("init: fork failed\n");
  84:	00001517          	auipc	a0,0x1
  88:	90c50513          	addi	a0,a0,-1780 # 990 <malloc+0x124>
  ...
  a2:	90a50513          	addi	a0,a0,-1782 # 9a8 <malloc+0x13c>
  a6:	2e2000ef          	jal	388 <exec>
      printf("init: exec sh failed\n");
  aa:	00001517          	auipc	a0,0x1
  ae:	90650513          	addi	a0,a0,-1786 # 9b0 <malloc+0x144>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 46c:	58850513          	addi	a0,a0,1416 # 9f0 <digits>
 470:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 702:	2f2b8b93          	addi	s7,s7,754 # 9f0 <digits>
 ...
 764:	28890913          	addi	s2,s2,648 # 9e8 <malloc+0x17c>
        for(; *s; s++)
...
malloc(uint nbytes)
{
 ...
 88c:	78853503          	ld	a0,1928(a0) # 1010 <freep>
 ...
 8bc:	75890913          	addi	s2,s2,1880 # 1010 <freep>
  if(p == SBRK_ERROR)
 8c0:	5afd                	li	s5,-1
 ...
 946:	6ca73723          	sd	a0,1742(a4) # 1010 <freep>
      return (void*)(p + 1);
