...
forktest(void)
{
  ...
  36:	41e50513          	addi	a0,a0,1054 # 450 <set_filter+0xe>
  ...
  58:	44c50513          	addi	a0,a0,1100 # 4a0 <set_filter+0x5e>
  ...
  6e:	3f650513          	addi	a0,a0,1014 # 460 <set_filter+0x1e>
  ...
  80:	3fc50513          	addi	a0,a0,1020 # 478 <set_filter+0x36>
  ...
  b0:	3e450513          	addi	a0,a0,996 # 490 <set_filter+0x4e>
