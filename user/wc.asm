...
wc(int fd, char *name)
{
  ...
  3c:	9d8a0a13          	addi	s4,s4,-1576 # a10 <malloc+0x104>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  a2:	99250513          	addi	a0,a0,-1646 # a30 <malloc+0x124>
  ...
  cc:	95850513          	addi	a0,a0,-1704 # a20 <malloc+0x114>
...
main(int argc, char *argv[])
{
 ...
 136:	8e658593          	addi	a1,a1,-1818 # a18 <malloc+0x10c>
 13a:	4501                	li	a0,0
 ...
 14e:	8f650513          	addi	a0,a0,-1802 # a40 <malloc+0x134>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 50c:	55850513          	addi	a0,a0,1368 # a60 <digits>
 510:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 7a2:	2c2b8b93          	addi	s7,s7,706 # a60 <digits>
 ...
 804:	25890913          	addi	s2,s2,600 # a58 <malloc+0x14c>
        for(; *s; s++)
