...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3c2:	50a50513          	addi	a0,a0,1290 # 8c8 <digits>
 3c6:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 658:	274b8b93          	addi	s7,s7,628 # 8c8 <digits>
 ...
 6ba:	20a90913          	addi	s2,s2,522 # 8c0 <malloc+0xfe>
        for(; *s; s++)
