...
void recursive_function(int depth) {
  ...
  34:	97050513          	addi	a0,a0,-1680 # 9a0 <malloc+0x106>
  38:	7ae000ef          	jal	7e6 <printf>
...
int main() {
  ...
  70:	95c50513          	addi	a0,a0,-1700 # 9c8 <malloc+0x12e>
  74:	772000ef          	jal	7e6 <printf>
  ...
  8c:	98050513          	addi	a0,a0,-1664 # a08 <malloc+0x16e>
  90:	756000ef          	jal	7e6 <printf>
        exit(0);
  94:	4501                	li	a0,0
  96:	2e8000ef          	jal	37e <exit>
        printf("Fork failed!\n");
  9a:	00001517          	auipc	a0,0x1
  9e:	95e50513          	addi	a0,a0,-1698 # 9f8 <malloc+0x15e>
  ...
  b8:	98450513          	addi	a0,a0,-1660 # a38 <malloc+0x19e>
  bc:	72a000ef          	jal	7e6 <printf>
        printf("[OK] Page Fault detected! Child process hit the Guard Page.\n");
  c0:	00001517          	auipc	a0,0x1
  c4:	9b050513          	addi	a0,a0,-1616 # a70 <malloc+0x1d6>
  c8:	71e000ef          	jal	7e6 <printf>
        printf("[OK] Stack Overflow handled safely by xv6 Kernel! ✅\n");
  cc:	00001517          	auipc	a0,0x1
  d0:	9e450513          	addi	a0,a0,-1564 # ab0 <malloc+0x216>
  d4:	712000ef          	jal	7e6 <printf>
        printf("--------------------------------------------------\n");
  d8:	00001517          	auipc	a0,0x1
  dc:	a1050513          	addi	a0,a0,-1520 # ae8 <malloc+0x24e>
  e0:	706000ef          	jal	7e6 <printf>
    }
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 49a:	69250513          	addi	a0,a0,1682 # b28 <digits>
 49e:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 730:	3fcb8b93          	addi	s7,s7,1020 # b28 <digits>
 ...
 792:	39290913          	addi	s2,s2,914 # b20 <malloc+0x286>
        for(; *s; s++)
