...
getcmd(char *buf, int nbuf)
{
  ...
  write(2, "$ ", 2);
      ...
      16:	23e58593          	addi	a1,a1,574 # 1250 <malloc+0x106>
      1a:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      58:	20c58593          	addi	a1,a1,524 # 1260 <malloc+0x116>
      5c:	4509                	li	a0,2
      5e:	00e010ef          	jal	106c <fprintf>
  exit(1);
      62:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      86:	1e650513          	addi	a0,a0,486 # 1268 <malloc+0x11e>
...
000000000000008e <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      ae:	2be70713          	addi	a4,a4,702 # 1368 <malloc+0x21e>
    ...
    panic("runcmd");
      ...
      c6:	1ae50513          	addi	a0,a0,430 # 1270 <malloc+0x126>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
      ...
      e0:	19c58593          	addi	a1,a1,412 # 1278 <malloc+0x12e>
      e4:	4509                	li	a0,2
      e6:	787000ef          	jal	106c <fprintf>
  exit(0);
      ea:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     114:	17858593          	addi	a1,a1,376 # 1288 <malloc+0x13e>
     118:	4509                	li	a0,2
     11a:	753000ef          	jal	106c <fprintf>
      exit(1);
     11e:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     176:	12650513          	addi	a0,a0,294 # 1298 <malloc+0x14e>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     4d0:	df4a8a93          	addi	s5,s5,-524 # 12c0 <malloc+0x176>
  ...
  while(peek(ps, es, "<>")){
     ...
     4e2:	dc250513          	addi	a0,a0,-574 # 12a0 <malloc+0x156>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     59e:	d2e60613          	addi	a2,a2,-722 # 12c8 <malloc+0x17e>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     5ce:	d1eb0b13          	addi	s6,s6,-738 # 12e8 <malloc+0x19e>
  ...
  return ret;
     ...
     5f8:	cdc50513          	addi	a0,a0,-804 # 12d0 <malloc+0x186>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     64a:	c9250513          	addi	a0,a0,-878 # 12d8 <malloc+0x18e>
...
000000000000066c <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     688:	c6c60613          	addi	a2,a2,-916 # 12f0 <malloc+0x1a6>
     68c:	85ce                	mv	a1,s3
     68e:	854a                	mv	a0,s2
...
00000000000006c6 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     6e4:	c18a0a13          	addi	s4,s4,-1000 # 12f8 <malloc+0x1ae>
  ...
  if(peek(ps, es, ";")){
     ...
     70e:	bf660613          	addi	a2,a2,-1034 # 1300 <malloc+0x1b6>
     712:	85ce                	mv	a1,s3
     714:	854a                	mv	a0,s2
...
000000000000074e <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     764:	b6860613          	addi	a2,a2,-1176 # 12c8 <malloc+0x17e>
  ...
  if(!peek(ps, es, ")"))
     ...
     788:	b9460613          	addi	a2,a2,-1132 # 1318 <malloc+0x1ce>
     78c:	85ca                	mv	a1,s2
     78e:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     7be:	b4e50513          	addi	a0,a0,-1202 # 1308 <malloc+0x1be>
     7c2:	889ff0ef          	jal	4a <panic>
    panic("syntax - missing )");
     7c6:	00001517          	auipc	a0,0x1
     7ca:	b5a50513          	addi	a0,a0,-1190 # 1320 <malloc+0x1d6>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     7f2:	b9270713          	addi	a4,a4,-1134 # 1380 <malloc+0x236>
...
0000000000000852 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     87e:	9de60613          	addi	a2,a2,-1570 # 1258 <malloc+0x10e>
     882:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     8ac:	a9058593          	addi	a1,a1,-1392 # 1338 <malloc+0x1ee>
     8b0:	4509                	li	a0,2
     8b2:	7ba000ef          	jal	106c <fprintf>
    panic("syntax");
     8b6:	00001517          	auipc	a0,0x1
     8ba:	a1a50513          	addi	a0,a0,-1510 # 12d0 <malloc+0x186>
...
00000000000008c2 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     8da:	a7248493          	addi	s1,s1,-1422 # 1348 <malloc+0x1fe>
     8de:	4589                	li	a1,2
     8e0:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(cmd[0] == 'c' && cmd[1] == 'd' && cmd[2] == ' '){
     ...
     97e:	9d658593          	addi	a1,a1,-1578 # 1350 <malloc+0x206>
     982:	4509                	li	a0,2
     984:	6e8000ef          	jal	106c <fprintf>
...
putc(int fd, char c)
{
     ...
     d16:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
     d1a:	4605                	li	a2,1
     d1c:	fef40593          	addi	a1,s0,-17
     d20:	f2fff0ef          	jal	c4e <write>
}
...
{
     d2c:	715d                	addi	sp,sp,-80
     d2e:	e486                	sd	ra,72(sp)
     d30:	e0a2                	sd	s0,64(sp)
     d32:	f84a                	sd	s2,48(sp)
     d34:	0880                	addi	s0,sp,80
     d36:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
     d38:	c299                	beqz	a3,d3e <printint+0x12>
     d3a:	0805c363          	bltz	a1,dc0 <printint+0x94>
  neg = 0;
     d3e:	4881                	li	a7,0
     d40:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     d4a:	65250513          	addi	a0,a0,1618 # 1398 <digits>
     d4e:	883e                	mv	a6,a5
     d50:	2785                	addiw	a5,a5,1
     d52:	02c5f733          	remu	a4,a1,a2
     ...
     d68:	fec773e3          	bgeu	a4,a2,d4e <printint+0x22>
  if(neg)
     d6c:	00088b63          	beqz	a7,d82 <printint+0x56>
    buf[i++] = '-';
     d70:	fd078793          	addi	a5,a5,-48
     d74:	97a2                	add	a5,a5,s0
     d76:	02d00713          	li	a4,45
     d7a:	fee78423          	sb	a4,-24(a5)
     d7e:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
     d82:	02f05a63          	blez	a5,db6 <printint+0x8a>
     d86:	fc26                	sd	s1,56(sp)
     d88:	f44e                	sd	s3,40(sp)
     d8a:	fb840713          	addi	a4,s0,-72
     d8e:	00f704b3          	add	s1,a4,a5
     d92:	fff70993          	addi	s3,a4,-1
     d96:	99be                	add	s3,s3,a5
     d98:	37fd                	addiw	a5,a5,-1
     d9a:	1782                	slli	a5,a5,0x20
     d9c:	9381                	srli	a5,a5,0x20
     d9e:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
     da2:	fff4c583          	lbu	a1,-1(s1)
     da6:	854a                	mv	a0,s2
     da8:	f67ff0ef          	jal	d0e <putc>
  while(--i >= 0)
     dac:	14fd                	addi	s1,s1,-1
     dae:	ff349ae3          	bne	s1,s3,da2 <printint+0x76>
     db2:	74e2                	ld	s1,56(sp)
     db4:	79a2                	ld	s3,40(sp)
}
     db6:	60a6                	ld	ra,72(sp)
     db8:	6406                	ld	s0,64(sp)
     dba:	7942                	ld	s2,48(sp)
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
     ...
     dd6:	28090663          	beqz	s2,1062 <vprintf+0x29a>
  ...
  for(i = 0; fmt[i]; i++){
     ...
     e1e:	22090a63          	beqz	s2,1052 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    ...
    if(state == 0){
     ...
     e40:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
     e44:	05878363          	beq	a5,s8,e8a <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
     e48:	05978d63          	beq	a5,s9,ea2 <vprintf+0xda>
     ...
     e50:	0ee78763          	beq	a5,a4,f3e <vprintf+0x176>
     ...
     e58:	12e78963          	beq	a5,a4,f8a <vprintf+0x1c2>
     ...
     e60:	14e78e63          	beq	a5,a4,fbc <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
     e64:	06300713          	li	a4,99
     e68:	18e78e63          	beq	a5,a4,1004 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
     e6c:	07300713          	li	a4,115
     e70:	1ae78463          	beq	a5,a4,1018 <vprintf+0x250>
     ...
     e78:	04e79563          	bne	a5,a4,ec2 <vprintf+0xfa>
        putc(fd, '%');
     e7c:	02500593          	li	a1,37
     e80:	855a                	mv	a0,s6
     e82:	e8dff0ef          	jal	d0e <putc>
     ...
     e96:	855a                	mv	a0,s6
     e98:	e95ff0ef          	jal	d2c <printint>
     e9c:	8bca                	mv	s7,s2
      state = 0;
     e9e:	4981                	li	s3,0
     ea0:	bf8d                	j	e12 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
     ea2:	06400793          	li	a5,100
     ea6:	02f68963          	beq	a3,a5,ed8 <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     eaa:	06c00793          	li	a5,108
     eae:	04f68263          	beq	a3,a5,ef2 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
     eb2:	07500793          	li	a5,117
     eb6:	0af68063          	beq	a3,a5,f56 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
     eba:	07800793          	li	a5,120
     ebe:	0ef68263          	beq	a3,a5,fa2 <vprintf+0x1da>
        putc(fd, '%');
     ec2:	02500593          	li	a1,37
     ec6:	855a                	mv	a0,s6
     ec8:	e47ff0ef          	jal	d0e <putc>
        putc(fd, c0);
     ecc:	85ca                	mv	a1,s2
     ece:	855a                	mv	a0,s6
     ed0:	e3fff0ef          	jal	d0e <putc>
      state = 0;
     ed4:	4981                	li	s3,0
     ed6:	bf35                	j	e12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
     ...
     eee:	4981                	li	s3,0
        i += 1;
     ef0:	b70d                	j	e12 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
     ef2:	06400793          	li	a5,100
     ef6:	02f60763          	beq	a2,a5,f24 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
     efa:	07500793          	li	a5,117
     efe:	06f60963          	beq	a2,a5,f70 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
     f02:	07800793          	li	a5,120
     f06:	faf61ee3          	bne	a2,a5,ec2 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
     ...
     f4a:	855a                	mv	a0,s6
     f4c:	de1ff0ef          	jal	d2c <printint>
     f50:	8bca                	mv	s7,s2
      state = 0;
     f52:	4981                	li	s3,0
     f54:	bd7d                	j	e12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
     ...
     f7c:	855a                	mv	a0,s6
     f7e:	dafff0ef          	jal	d2c <printint>
        i += 2;
     f82:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
     f84:	8bca                	mv	s7,s2
      state = 0;
     f86:	4981                	li	s3,0
        i += 2;
     f88:	b569                	j	e12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
     f8a:	008b8913          	addi	s2,s7,8
     f8e:	4681                	li	a3,0
     f90:	4641                	li	a2,16
     f92:	000be583          	lwu	a1,0(s7)
     f96:	855a                	mv	a0,s6
     f98:	d95ff0ef          	jal	d2c <printint>
     f9c:	8bca                	mv	s7,s2
      state = 0;
     f9e:	4981                	li	s3,0
     fa0:	bd8d                	j	e12 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
     fa2:	008b8913          	addi	s2,s7,8
     fa6:	4681                	li	a3,0
     fa8:	4641                	li	a2,16
     faa:	000bb583          	ld	a1,0(s7)
     fae:	855a                	mv	a0,s6
     fb0:	d7dff0ef          	jal	d2c <printint>
        i += 1;
     fb4:	2485                	addiw	s1,s1,1
        printint(fd, va_arg(ap, uint64), 16, 0);
     fb6:	8bca                	mv	s7,s2
      state = 0;
     fb8:	4981                	li	s3,0
        i += 1;
     fba:	bda1                	j	e12 <vprintf+0x4a>
     fbc:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
     fbe:	008b8d13          	addi	s10,s7,8
     fc2:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
     fc6:	03000593          	li	a1,48
     fca:	855a                	mv	a0,s6
     fcc:	d43ff0ef          	jal	d0e <putc>
  putc(fd, 'x');
     fd0:	07800593          	li	a1,120
     fd4:	855a                	mv	a0,s6
     fd6:	d39ff0ef          	jal	d0e <putc>
     fda:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     fdc:	00000b97          	auipc	s7,0x0
     fe0:	3bcb8b93          	addi	s7,s7,956 # 1398 <digits>
     fe4:	03c9d793          	srli	a5,s3,0x3c
     fe8:	97de                	add	a5,a5,s7
     fea:	0007c583          	lbu	a1,0(a5)
     fee:	855a                	mv	a0,s6
     ff0:	d1fff0ef          	jal	d0e <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
     ff4:	0992                	slli	s3,s3,0x4
     ff6:	397d                	addiw	s2,s2,-1
     ff8:	fe0916e3          	bnez	s2,fe4 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
     ffc:	8bea                	mv	s7,s10
      state = 0;
     ffe:	4981                	li	s3,0
    1000:	6d02                	ld	s10,0(sp)
    1002:	bd01                	j	e12 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    1004:	008b8913          	addi	s2,s7,8
    1008:	000bc583          	lbu	a1,0(s7)
    100c:	855a                	mv	a0,s6
    100e:	d01ff0ef          	jal	d0e <putc>
    1012:	8bca                	mv	s7,s2
      state = 0;
    1014:	4981                	li	s3,0
    1016:	bbf5                	j	e12 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    1018:	008b8993          	addi	s3,s7,8
    101c:	000bb903          	ld	s2,0(s7)
    1020:	00090f63          	beqz	s2,103e <vprintf+0x276>
        for(; *s; s++)
    1024:	00094583          	lbu	a1,0(s2)
    1028:	c195                	beqz	a1,104c <vprintf+0x284>
          putc(fd, *s);
    102a:	855a                	mv	a0,s6
    102c:	ce3ff0ef          	jal	d0e <putc>
        for(; *s; s++)
    1030:	0905                	addi	s2,s2,1
    1032:	00094583          	lbu	a1,0(s2)
    1036:	f9f5                	bnez	a1,102a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    1038:	8bce                	mv	s7,s3
      state = 0;
    103a:	4981                	li	s3,0
    103c:	bbd9                	j	e12 <vprintf+0x4a>
          s = "(null)";
    103e:	00000917          	auipc	s2,0x0
    1042:	32290913          	addi	s2,s2,802 # 1360 <malloc+0x216>
        for(; *s; s++)
    1046:	02800593          	li	a1,40
    104a:	b7c5                	j	102a <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    104c:	8bce                	mv	s7,s3
      state = 0;
    104e:	4981                	li	s3,0
    1050:	b3c9                	j	e12 <vprintf+0x4a>
    1052:	64a6                	ld	s1,72(sp)
    1054:	79e2                	ld	s3,56(sp)
    1056:	7a42                	ld	s4,48(sp)
    1058:	7aa2                	ld	s5,40(sp)
    105a:	7b02                	ld	s6,32(sp)
    105c:	6be2                	ld	s7,24(sp)
    105e:	6c42                	ld	s8,16(sp)
    1060:	6ca2                	ld	s9,8(sp)
    }
  }
}
    1062:	60e6                	ld	ra,88(sp)
    1064:	6446                	ld	s0,80(sp)
    1066:	6906                	ld	s2,64(sp)
    1068:	6125                	addi	sp,sp,96
    106a:	8082                	ret

000000000000106c <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    106c:	715d                	addi	sp,sp,-80
    106e:	ec06                	sd	ra,24(sp)
    1070:	e822                	sd	s0,16(sp)
    1072:	1000                	addi	s0,sp,32
    1074:	e010                	sd	a2,0(s0)
    1076:	e414                	sd	a3,8(s0)
    1078:	e818                	sd	a4,16(s0)
    107a:	ec1c                	sd	a5,24(s0)
    107c:	03043023          	sd	a6,32(s0)
    1080:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    1084:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1088:	8622                	mv	a2,s0
    108a:	d3fff0ef          	jal	dc8 <vprintf>
}
...
0000000000001096 <printf>:

void
printf(const char *fmt, ...)
{
    1096:	711d                	addi	sp,sp,-96
    1098:	ec06                	sd	ra,24(sp)
    109a:	e822                	sd	s0,16(sp)
    109c:	1000                	addi	s0,sp,32
    109e:	e40c                	sd	a1,8(s0)
    10a0:	e810                	sd	a2,16(s0)
    10a2:	ec14                	sd	a3,24(s0)
    10a4:	f018                	sd	a4,32(s0)
    10a6:	f41c                	sd	a5,40(s0)
    10a8:	03043823          	sd	a6,48(s0)
    10ac:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    10b0:	00840613          	addi	a2,s0,8
    10b4:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    10b8:	85aa                	mv	a1,a0
    10ba:	4505                	li	a0,1
    10bc:	d0dff0ef          	jal	dc8 <vprintf>
}
    10c0:	60e2                	ld	ra,24(sp)
    10c2:	6442                	ld	s0,16(sp)
    10c4:	6125                	addi	sp,sp,96
    10c6:	8082                	ret

00000000000010c8 <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    10ca:	e422                	sd	s0,8(sp)
    10cc:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    10ce:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    10d2:	00001797          	auipc	a5,0x1
    10d6:	f3e7b783          	ld	a5,-194(a5) # 2010 <freep>
    10da:	a02d                	j	1104 <free+0x3c>
  ...
  if(p + p->s.size == bp){
    ...
    10f6:	a091                	j	113a <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    10f8:	6398                	ld	a4,0(a5)
    10fa:	00e7e463          	bltu	a5,a4,1102 <free+0x3a>
    10fe:	00e6ea63          	bltu	a3,a4,1112 <free+0x4a>
{
    1102:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1104:	fed7fae3          	bgeu	a5,a3,10f8 <free+0x30>
    1108:	6398                	ld	a4,0(a5)
    110a:	00e6e463          	bltu	a3,a4,1112 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    110e:	fee7eae3          	bltu	a5,a4,1102 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    1112:	ff852583          	lw	a1,-8(a0)
    1116:	6390                	ld	a2,0(a5)
    1118:	02059813          	slli	a6,a1,0x20
    111c:	01c85713          	srli	a4,a6,0x1c
    1120:	9736                	add	a4,a4,a3
    1122:	fae60de3          	beq	a2,a4,10dc <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    1126:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    112a:	4790                	lw	a2,8(a5)
    112c:	02061593          	slli	a1,a2,0x20
    1130:	01c5d713          	srli	a4,a1,0x1c
    1134:	973e                	add	a4,a4,a5
    1136:	fae68ae3          	beq	a3,a4,10ea <free+0x22>
    p->s.ptr = bp->s.ptr;
    113a:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1156:	02051493          	slli	s1,a0,0x20
    115a:	9081                	srli	s1,s1,0x20
    115c:	04bd                	addi	s1,s1,15
    115e:	8091                	srli	s1,s1,0x4
    1160:	0014899b          	addiw	s3,s1,1
    1164:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    1166:	00001517          	auipc	a0,0x1
    116a:	eaa53503          	ld	a0,-342(a0) # 2010 <freep>
    116e:	c915                	beqz	a0,11a2 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    1174:	08977a63          	bgeu	a4,s1,1208 <malloc+0xbe>
    1178:	f04a                	sd	s2,32(sp)
    117a:	e852                	sd	s4,16(sp)
    117c:	e456                	sd	s5,8(sp)
    117e:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    1180:	8a4e                	mv	s4,s3
    1182:	0009871b          	sext.w	a4,s3
    1186:	6685                	lui	a3,0x1
    1188:	00d77363          	bgeu	a4,a3,118e <malloc+0x44>
    118c:	6a05                	lui	s4,0x1
    118e:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1192:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    1196:	00001917          	auipc	s2,0x1
    119a:	e7a90913          	addi	s2,s2,-390 # 2010 <freep>
  if(p == SBRK_ERROR)
    119e:	5afd                	li	s5,-1
    11a0:	a081                	j	11e0 <malloc+0x96>
    ...
    11ae:	ede78793          	addi	a5,a5,-290 # 2088 <base>
    11b2:	00001717          	auipc	a4,0x1
    11b6:	e4f73f23          	sd	a5,-418(a4) # 2010 <freep>
    11ba:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    11bc:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    11c0:	b7c1                	j	1180 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    11c2:	6398                	ld	a4,0(a5)
    11c4:	e118                	sd	a4,0(a0)
    11c6:	a8a9                	j	1220 <malloc+0xd6>
  hp->s.size = nu;
    11c8:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    11cc:	0541                	addi	a0,a0,16
    11ce:	efbff0ef          	jal	10c8 <free>
  return freep;
    11d2:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    11d6:	c12d                	beqz	a0,1238 <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    11d8:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    11da:	4798                	lw	a4,8(a5)
    11dc:	02977263          	bgeu	a4,s1,1200 <malloc+0xb6>
    if(p == freep)
    11e0:	00093703          	ld	a4,0(s2)
    11e4:	853e                	mv	a0,a5
    11e6:	fef719e3          	bne	a4,a5,11d8 <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    11ea:	8552                	mv	a0,s4
    11ec:	a0fff0ef          	jal	bfa <sbrk>
  if(p == SBRK_ERROR)
    11f0:	fd551ce3          	bne	a0,s5,11c8 <malloc+0x7e>
        return 0;
    11f4:	4501                	li	a0,0
