...
ls(char *path)
{
  ...
  f8:	a5c50513          	addi	a0,a0,-1444 # b50 <malloc+0x134>
  fc:	06d000ef          	jal	968 <printf>
      }
 ...
 122:	a0258593          	addi	a1,a1,-1534 # b20 <malloc+0x104>
 126:	4509                	li	a0,2
 128:	017000ef          	jal	93e <fprintf>
    return;
 12c:	bff9                	j	10a <ls+0x6e>
    fprintf(2, "ls: cannot stat %s\n", path);
 12e:	864a                	mv	a2,s2
 130:	00001597          	auipc	a1,0x1
 134:	a0858593          	addi	a1,a1,-1528 # b38 <malloc+0x11c>
 138:	4509                	li	a0,2
 13a:	005000ef          	jal	93e <fprintf>
    close(fd);
 13e:	8526                	mv	a0,s1
 ...
 15e:	a0650513          	addi	a0,a0,-1530 # b60 <malloc+0x144>
 162:	007000ef          	jal	968 <printf>
      break;
 ...
 1a2:	9b2a0a13          	addi	s4,s4,-1614 # b50 <malloc+0x134>
        printf("ls: cannot stat %s\n", buf);
 1a6:	00001a97          	auipc	s5,0x1
 1aa:	992a8a93          	addi	s5,s5,-1646 # b38 <malloc+0x11c>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1ae:	a031                	j	1ba <ls+0x11e>
        printf("ls: cannot stat %s\n", buf);
 1b0:	dc040593          	addi	a1,s0,-576
 1b4:	8556                	mv	a0,s5
 1b6:	7b2000ef          	jal	968 <printf>
    while(read(fd, &de, sizeof(de)) == sizeof(de)){
 1ba:	4641                	li	a2,16
...
main(int argc, char *argv[])
{
 ...
 25e:	91e50513          	addi	a0,a0,-1762 # b78 <malloc+0x15c>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 600:	e486                	sd	ra,72(sp)
 602:	e0a2                	sd	s0,64(sp)
 ...
 60c:	0805c363          	bltz	a1,692 <printint+0x94>
  neg = 0;
 610:	4881                	li	a7,0
 612:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
 ...
 61c:	57050513          	addi	a0,a0,1392 # b88 <digits>
 620:	883e                	mv	a6,a5
 622:	2785                	addiw	a5,a5,1
 624:	02c5f733          	remu	a4,a1,a2
 628:	972a                	add	a4,a4,a0
 62a:	00074703          	lbu	a4,0(a4)
 62e:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
 632:	872e                	mv	a4,a1
 634:	02c5d5b3          	divu	a1,a1,a2
 638:	0685                	addi	a3,a3,1
 63a:	fec773e3          	bgeu	a4,a2,620 <printint+0x22>
  if(neg)
 63e:	00088b63          	beqz	a7,654 <printint+0x56>
    buf[i++] = '-';
 642:	fd078793          	addi	a5,a5,-48
 646:	97a2                	add	a5,a5,s0
 648:	02d00713          	li	a4,45
 64c:	fee78423          	sb	a4,-24(a5)
 650:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
 654:	02f05a63          	blez	a5,688 <printint+0x8a>
 658:	fc26                	sd	s1,56(sp)
 65a:	f44e                	sd	s3,40(sp)
 65c:	fb840713          	addi	a4,s0,-72
 660:	00f704b3          	add	s1,a4,a5
 664:	fff70993          	addi	s3,a4,-1
 668:	99be                	add	s3,s3,a5
 66a:	37fd                	addiw	a5,a5,-1
 66c:	1782                	slli	a5,a5,0x20
 66e:	9381                	srli	a5,a5,0x20
 670:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
 674:	fff4c583          	lbu	a1,-1(s1)
 678:	854a                	mv	a0,s2
 67a:	f67ff0ef          	jal	5e0 <putc>
  while(--i >= 0)
 67e:	14fd                	addi	s1,s1,-1
 680:	ff349ae3          	bne	s1,s3,674 <printint+0x76>
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6a8:	28090663          	beqz	s2,934 <vprintf+0x29a>
 6ac:	e4a6                	sd	s1,72(sp)
 ...
 6d4:	a005                	j	6f4 <vprintf+0x5a>
        putc(fd, c0);
 6d6:	85ca                	mv	a1,s2
 6d8:	855a                	mv	a0,s6
 6da:	f07ff0ef          	jal	5e0 <putc>
 6de:	a019                	j	6e4 <vprintf+0x4a>
    } else if(state == '%'){
 6e0:	03598263          	beq	s3,s5,704 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
 6e4:	2485                	addiw	s1,s1,1
 6e6:	8726                	mv	a4,s1
 6e8:	009a07b3          	add	a5,s4,s1
 6ec:	0007c903          	lbu	s2,0(a5)
 6f0:	22090a63          	beqz	s2,924 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
 6f4:	0009079b          	sext.w	a5,s2
    if(state == 0){
 6f8:	fe0994e3          	bnez	s3,6e0 <vprintf+0x46>
      if(c0 == '%'){
 6fc:	fd579de3          	bne	a5,s5,6d6 <vprintf+0x3c>
        state = '%';
 700:	89be                	mv	s3,a5
 702:	b7cd                	j	6e4 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
 ...
 70c:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
 70e:	c681                	beqz	a3,716 <vprintf+0x7c>
 710:	9752                	add	a4,a4,s4
 712:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
 716:	05878363          	beq	a5,s8,75c <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
 71a:	05978d63          	beq	a5,s9,774 <vprintf+0xda>
 ...
 722:	0ee78763          	beq	a5,a4,810 <vprintf+0x176>
 ...
 72a:	12e78963          	beq	a5,a4,85c <vprintf+0x1c2>
 ...
 732:	14e78e63          	beq	a5,a4,88e <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
 736:	06300713          	li	a4,99
 73a:	18e78e63          	beq	a5,a4,8d6 <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
 73e:	07300713          	li	a4,115
 742:	1ae78463          	beq	a5,a4,8ea <vprintf+0x250>
 ...
 74a:	04e79563          	bne	a5,a4,794 <vprintf+0xfa>
        putc(fd, '%');
 74e:	02500593          	li	a1,37
 752:	855a                	mv	a0,s6
 754:	e8dff0ef          	jal	5e0 <putc>
 ...
 768:	855a                	mv	a0,s6
 76a:	e95ff0ef          	jal	5fe <printint>
 76e:	8bca                	mv	s7,s2
      state = 0;
 770:	4981                	li	s3,0
 772:	bf8d                	j	6e4 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
 774:	06400793          	li	a5,100
 778:	02f68963          	beq	a3,a5,7aa <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 77c:	06c00793          	li	a5,108
 780:	04f68263          	beq	a3,a5,7c4 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
 784:	07500793          	li	a5,117
 788:	0af68063          	beq	a3,a5,828 <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
 78c:	07800793          	li	a5,120
 790:	0ef68263          	beq	a3,a5,874 <vprintf+0x1da>
        putc(fd, '%');
 794:	02500593          	li	a1,37
 798:	855a                	mv	a0,s6
 79a:	e47ff0ef          	jal	5e0 <putc>
        putc(fd, c0);
 79e:	85ca                	mv	a1,s2
 7a0:	855a                	mv	a0,s6
 7a2:	e3fff0ef          	jal	5e0 <putc>
      state = 0;
 7a6:	4981                	li	s3,0
 7a8:	bf35                	j	6e4 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
 ...
 7c0:	4981                	li	s3,0
        i += 1;
 7c2:	b70d                	j	6e4 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
 7c4:	06400793          	li	a5,100
 7c8:	02f60763          	beq	a2,a5,7f6 <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
 7cc:	07500793          	li	a5,117
 7d0:	06f60963          	beq	a2,a5,842 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
 7d4:	07800793          	li	a5,120
 7d8:	faf61ee3          	bne	a2,a5,794 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 81c:	855a                	mv	a0,s6
 81e:	de1ff0ef          	jal	5fe <printint>
 822:	8bca                	mv	s7,s2
      state = 0;
 824:	4981                	li	s3,0
 826:	bd7d                	j	6e4 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
 ...
 84e:	855a                	mv	a0,s6
 850:	dafff0ef          	jal	5fe <printint>
        i += 2;
 854:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
 856:	8bca                	mv	s7,s2
      state = 0;
 858:	4981                	li	s3,0
        i += 2;
 85a:	b569                	j	6e4 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
 85c:	008b8913          	addi	s2,s7,8
 860:	4681                	li	a3,0
 862:	4641                	li	a2,16
 864:	000be583          	lwu	a1,0(s7)
 868:	855a                	mv	a0,s6
 86a:	d95ff0ef          	jal	5fe <printint>
 86e:	8bca                	mv	s7,s2
      state = 0;
 870:	4981                	li	s3,0
 872:	bd8d                	j	6e4 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
 ...
 89c:	855a                	mv	a0,s6
 89e:	d43ff0ef          	jal	5e0 <putc>
  putc(fd, 'x');
 8a2:	07800593          	li	a1,120
 8a6:	855a                	mv	a0,s6
 8a8:	d39ff0ef          	jal	5e0 <putc>
 8ac:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 8ae:	00000b97          	auipc	s7,0x0
 8b2:	2dab8b93          	addi	s7,s7,730 # b88 <digits>
 8b6:	03c9d793          	srli	a5,s3,0x3c
 8ba:	97de                	add	a5,a5,s7
 8bc:	0007c583          	lbu	a1,0(a5)
 8c0:	855a                	mv	a0,s6
 8c2:	d1fff0ef          	jal	5e0 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 8c6:	0992                	slli	s3,s3,0x4
 8c8:	397d                	addiw	s2,s2,-1
 8ca:	fe0916e3          	bnez	s2,8b6 <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
 8ce:	8bea                	mv	s7,s10
      state = 0;
 8d0:	4981                	li	s3,0
 8d2:	6d02                	ld	s10,0(sp)
 8d4:	bd01                	j	6e4 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
 8d6:	008b8913          	addi	s2,s7,8
 8da:	000bc583          	lbu	a1,0(s7)
 8de:	855a                	mv	a0,s6
 8e0:	d01ff0ef          	jal	5e0 <putc>
 8e4:	8bca                	mv	s7,s2
      state = 0;
 8e6:	4981                	li	s3,0
 8e8:	bbf5                	j	6e4 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
 8ea:	008b8993          	addi	s3,s7,8
 8ee:	000bb903          	ld	s2,0(s7)
 8f2:	00090f63          	beqz	s2,910 <vprintf+0x276>
        for(; *s; s++)
 8f6:	00094583          	lbu	a1,0(s2)
 8fa:	c195                	beqz	a1,91e <vprintf+0x284>
          putc(fd, *s);
 8fc:	855a                	mv	a0,s6
 8fe:	ce3ff0ef          	jal	5e0 <putc>
        for(; *s; s++)
 902:	0905                	addi	s2,s2,1
 904:	00094583          	lbu	a1,0(s2)
 908:	f9f5                	bnez	a1,8fc <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
 90a:	8bce                	mv	s7,s3
      state = 0;
 90c:	4981                	li	s3,0
 90e:	bbd9                	j	6e4 <vprintf+0x4a>
          s = "(null)";
 910:	00000917          	auipc	s2,0x0
 914:	27090913          	addi	s2,s2,624 # b80 <malloc+0x164>
        for(; *s; s++)
 918:	02800593          	li	a1,40
 91c:	b7c5                	j	8fc <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
 91e:	8bce                	mv	s7,s3
      state = 0;
 920:	4981                	li	s3,0
 922:	b3c9                	j	6e4 <vprintf+0x4a>
 924:	64a6                	ld	s1,72(sp)
...
free(void *ap)
{
 ...
 9a8:	65c7b783          	ld	a5,1628(a5) # 1000 <freep>
...
malloc(uint nbytes)
{
 ...
 a40:	c915                	beqz	a0,a74 <malloc+0x58>
 ...
 a42:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 a44:	4798                	lw	a4,8(a5)
 a46:	08977a63          	bgeu	a4,s1,ada <malloc+0xbe>
 ...
 a6c:	59890913          	addi	s2,s2,1432 # 1000 <freep>
  if(p == SBRK_ERROR)
 a70:	5afd                	li	s5,-1
 a72:	a081                	j	ab2 <malloc+0x96>
 ...
 a80:	5a478793          	addi	a5,a5,1444 # 1020 <base>
 a84:	00000717          	auipc	a4,0x0
 a88:	56f73e23          	sd	a5,1404(a4) # 1000 <freep>
 a8c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 a8e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
 a92:	b7c1                	j	a52 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
 a94:	6398                	ld	a4,0(a5)
 a96:	e118                	sd	a4,0(a0)
 a98:	a8a9                	j	af2 <malloc+0xd6>
  hp->s.size = nu;
 a9a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
 a9e:	0541                	addi	a0,a0,16
 aa0:	efbff0ef          	jal	99a <free>
  return freep;
 aa4:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 aa8:	c12d                	beqz	a0,b0a <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 aaa:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 aac:	4798                	lw	a4,8(a5)
 aae:	02977263          	bgeu	a4,s1,ad2 <malloc+0xb6>
    if(p == freep)
 ab2:	00093703          	ld	a4,0(s2)
 ab6:	853e                	mv	a0,a5
 ab8:	fef719e3          	bne	a4,a5,aaa <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
 abc:	8552                	mv	a0,s4
 abe:	a0fff0ef          	jal	4cc <sbrk>
  if(p == SBRK_ERROR)
 ac2:	fd551ce3          	bne	a0,s5,a9a <malloc+0x7e>
        return 0;
 ac6:	4501                	li	a0,0
 ...
 acc:	6aa2                	ld	s5,8(sp)
 ace:	6b02                	ld	s6,0(sp)
 ad0:	a03d                	j	afe <malloc+0xe2>
 ad2:	7902                	ld	s2,32(sp)
 ad4:	6a42                	ld	s4,16(sp)
 ad6:	6aa2                	ld	s5,8(sp)
 ad8:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
 ada:	fae48de3          	beq	s1,a4,a94 <malloc+0x78>
        p->s.size -= nunits;
 ade:	4137073b          	subw	a4,a4,s3
 ae2:	c798                	sw	a4,8(a5)
        p += p->s.size;
 ae4:	02071693          	slli	a3,a4,0x20
 ae8:	01c6d713          	srli	a4,a3,0x1c
 aec:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
 aee:	0137a423          	sw	s3,8(a5)
      freep = prevp;
 af2:	00000717          	auipc	a4,0x0
 af6:	50a73723          	sd	a0,1294(a4) # 1000 <freep>
      return (void*)(p + 1);
