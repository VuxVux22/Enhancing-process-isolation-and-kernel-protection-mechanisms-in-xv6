...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 3ce:	50e50513          	addi	a0,a0,1294 # 8d8 <digits>
 3d2:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 664:	278b8b93          	addi	s7,s7,632 # 8d8 <digits>
 ...
 6c6:	20e90913          	addi	s2,s2,526 # 8d0 <malloc+0x102>
        for(; *s; s++)
