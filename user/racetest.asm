...
main(void)
{
  ...
  printf("=== WITHOUT LOCK ===\n");
   ...
   e:	93650513          	addi	a0,a0,-1738 # 940 <malloc+0x104>
  12:	776000ef          	jal	788 <printf>
  ...
  36:	92650513          	addi	a0,a0,-1754 # 958 <malloc+0x11c>
  3a:	74e000ef          	jal	788 <printf>

  printf("\n=== WITH SPINLOCK ===\n");
  3e:	00001517          	auipc	a0,0x1
  42:	93a50513          	addi	a0,a0,-1734 # 978 <malloc+0x13c>
  ...
  6a:	92a50513          	addi	a0,a0,-1750 # 990 <malloc+0x154>
...
printint(int fd, long long xx, int base, int sgn)
{
 ...
 43c:	58050513          	addi	a0,a0,1408 # 9b8 <digits>
 440:	883e                	mv	a6,a5
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6d2:	2eab8b93          	addi	s7,s7,746 # 9b8 <digits>
 ...
 734:	28090913          	addi	s2,s2,640 # 9b0 <malloc+0x174>
        for(; *s; s++)
