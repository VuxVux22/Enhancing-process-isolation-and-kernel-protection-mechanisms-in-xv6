...
cat(int fd)
{
  ...
  3c:	96858593          	addi	a1,a1,-1688 # 9a0 <malloc+0x106>
  40:	4509                	li	a0,2
  42:	77a000ef          	jal	7bc <fprintf>
      exit(1);
  46:	4505                	li	a0,1
  ...
  62:	95a58593          	addi	a1,a1,-1702 # 9b8 <malloc+0x11e>
  66:	4509                	li	a0,2
  68:	754000ef          	jal	7bc <fprintf>
    exit(1);
  6c:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  da:	8fa58593          	addi	a1,a1,-1798 # 9d0 <malloc+0x136>
  de:	4509                	li	a0,2
  e0:	6dc000ef          	jal	7bc <fprintf>
      exit(1);
  e4:	4505                	li	a0,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 730:	2c4b8b93          	addi	s7,s7,708 # 9f0 <digits>
