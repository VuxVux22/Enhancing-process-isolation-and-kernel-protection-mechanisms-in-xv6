...
copyinstr1(char *s)
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
      ...
      12:	90278793          	addi	a5,a5,-1790 # 7910 <malloc+0x2680>
      16:	638c                	ld	a1,0(a5)
      18:	6790                	ld	a2,8(a5)
      1a:	6b94                	ld	a3,16(a5)
      1c:	6f98                	ld	a4,24(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
      ...
      6a:	32a50513          	addi	a0,a0,810 # 5390 <malloc+0x100>
      6e:	16e050ef          	jal	51dc <printf>
      exit(1);
      72:	4505                	li	a0,1
      ...
      94:	8082                	ret
{
      ...
      a4:	31050513          	addi	a0,a0,784 # 53b0 <malloc+0x120>
      a8:	134050ef          	jal	51dc <printf>
      exit(1);
      ac:	4505                	li	a0,1
...
00000000000000b2 <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      c4:	30850513          	addi	a0,a0,776 # 53c8 <malloc+0x138>
  ...
  fd = open("doesnotexist", 0);
      ...
      da:	31250513          	addi	a0,a0,786 # 53e8 <malloc+0x158>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      f6:	2de50513          	addi	a0,a0,734 # 53d0 <malloc+0x140>
      fa:	0e2050ef          	jal	51dc <printf>
    exit(1);
      fe:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     10a:	2f250513          	addi	a0,a0,754 # 53f8 <malloc+0x168>
     10e:	0ce050ef          	jal	51dc <printf>
    exit(1);
     112:	4505                	li	a0,1
...
0000000000000118 <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     180:	2a450513          	addi	a0,a0,676 # 5420 <malloc+0x190>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1aa:	29a50513          	addi	a0,a0,666 # 5440 <malloc+0x1b0>
     1ae:	02e050ef          	jal	51dc <printf>
    exit(1);
     1b2:	4505                	li	a0,1
...
000000000000022c <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     248:	22450513          	addi	a0,a0,548 # 5468 <malloc+0x1d8>
     24c:	379040ef          	jal	4dc4 <unlink>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     250:	1f300493          	li	s1,499
    fd = open("bigwrite", O_CREATE | O_RDWR);
     254:	00005a97          	auipc	s5,0x5
     258:	214a8a93          	addi	s5,s5,532 # 5468 <malloc+0x1d8>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     2c6:	1b650513          	addi	a0,a0,438 # 5478 <malloc+0x1e8>
     2ca:	713040ef          	jal	51dc <printf>
      exit(1);
     2ce:	4505                	li	a0,1
     ...
     2e0:	1bc50513          	addi	a0,a0,444 # 5498 <malloc+0x208>
     2e4:	6f9040ef          	jal	51dc <printf>
        exit(1);
     2e8:	4505                	li	a0,1
...
badwrite(char *s)
{
  ...
  unlink("junk");
     ...
     302:	1b250513          	addi	a0,a0,434 # 54b0 <malloc+0x220>
     306:	2bf040ef          	jal	4dc4 <unlink>
     30a:	25800913          	li	s2,600
  for(int i = 0; i < assumed_free; i++){
    int fd = open("junk", O_CREATE|O_WRONLY);
     30e:	00005997          	auipc	s3,0x5
     312:	1a298993          	addi	s3,s3,418 # 54b0 <malloc+0x220>
    if(fd < 0){
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
     ...
     34e:	16650513          	addi	a0,a0,358 # 54b0 <malloc+0x220>
  ...
  if(write(fd, "x", 1) != 1){
     ...
     362:	0da58593          	addi	a1,a1,218 # 5438 <malloc+0x1a8>
     366:	22f040ef          	jal	4d94 <write>
     36a:	4785                	li	a5,1
     36c:	02f50d63          	beq	a0,a5,3a6 <badwrite+0xb8>
    printf("write failed\n");
     370:	00005517          	auipc	a0,0x5
     374:	16050513          	addi	a0,a0,352 # 54d0 <malloc+0x240>
     378:	665040ef          	jal	51dc <printf>
    exit(1);
     37c:	4505                	li	a0,1
     37e:	1f7040ef          	jal	4d74 <exit>
      printf("open junk failed\n");
     382:	00005517          	auipc	a0,0x5
     386:	13650513          	addi	a0,a0,310 # 54b8 <malloc+0x228>
     38a:	653040ef          	jal	51dc <printf>
      exit(1);
     38e:	4505                	li	a0,1
     390:	1e5040ef          	jal	4d74 <exit>
    printf("open junk failed\n");
     394:	00005517          	auipc	a0,0x5
     398:	12450513          	addi	a0,a0,292 # 54b8 <malloc+0x228>
     39c:	641040ef          	jal	51dc <printf>
    exit(1);
     3a0:	4505                	li	a0,1
  ...
  unlink("junk");
     ...
     3b0:	10450513          	addi	a0,a0,260 # 54b0 <malloc+0x220>
...
000000000000047e <copyin>:
{
  ...
  uint64 addrs[] = { 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     494:	48078793          	addi	a5,a5,1152 # 7910 <malloc+0x2680>
     498:	638c                	ld	a1,0(a5)
     49a:	6790                	ld	a2,8(a5)
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     4c2:	022a0a13          	addi	s4,s4,34 # 54e0 <malloc+0x250>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     548:	fa450513          	addi	a0,a0,-92 # 54e8 <malloc+0x258>
     54c:	491040ef          	jal	51dc <printf>
      exit(1);
     550:	4505                	li	a0,1
     ...
     55e:	fa650513          	addi	a0,a0,-90 # 5500 <malloc+0x270>
     562:	47b040ef          	jal	51dc <printf>
      exit(1);
     566:	4505                	li	a0,1
     ...
     574:	fc050513          	addi	a0,a0,-64 # 5530 <malloc+0x2a0>
     578:	465040ef          	jal	51dc <printf>
      exit(1);
     57c:	4505                	li	a0,1
     57e:	7f6040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     582:	00005517          	auipc	a0,0x5
     586:	fde50513          	addi	a0,a0,-34 # 5560 <malloc+0x2d0>
     58a:	453040ef          	jal	51dc <printf>
      exit(1);
     58e:	4505                	li	a0,1
     ...
     59c:	fd850513          	addi	a0,a0,-40 # 5570 <malloc+0x2e0>
     5a0:	43d040ef          	jal	51dc <printf>
      exit(1);
     5a4:	4505                	li	a0,1
...
00000000000005aa <copyout>:
{
  ...
  uint64 addrs[] = { 0LL, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
     ...
     5c2:	35278793          	addi	a5,a5,850 # 7910 <malloc+0x2680>
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
    ...
    int fd = open("README", 0);
     ...
     5f6:	faea0a13          	addi	s4,s4,-82 # 55a0 <malloc+0x310>
    n = write(fds[1], "x", 1);
     5fa:	00005a97          	auipc	s5,0x5
     5fe:	e3ea8a93          	addi	s5,s5,-450 # 5438 <malloc+0x1a8>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < sizeof(addrs)/sizeof(addrs[0]); ai++){
     ...
     682:	f2a50513          	addi	a0,a0,-214 # 55a8 <malloc+0x318>
     686:	357040ef          	jal	51dc <printf>
      exit(1);
     68a:	4505                	li	a0,1
     ...
     698:	f2c50513          	addi	a0,a0,-212 # 55c0 <malloc+0x330>
     69c:	341040ef          	jal	51dc <printf>
      exit(1);
     6a0:	4505                	li	a0,1
     6a2:	6d2040ef          	jal	4d74 <exit>
      printf("pipe() failed\n");
     6a6:	00005517          	auipc	a0,0x5
     6aa:	eba50513          	addi	a0,a0,-326 # 5560 <malloc+0x2d0>
     6ae:	32f040ef          	jal	51dc <printf>
      exit(1);
     6b2:	4505                	li	a0,1
     6b4:	6c0040ef          	jal	4d74 <exit>
      printf("pipe write failed\n");
     6b8:	00005517          	auipc	a0,0x5
     6bc:	f3850513          	addi	a0,a0,-200 # 55f0 <malloc+0x360>
     6c0:	31d040ef          	jal	51dc <printf>
      exit(1);
     6c4:	4505                	li	a0,1
     ...
     6d2:	f3a50513          	addi	a0,a0,-198 # 5608 <malloc+0x378>
     6d6:	307040ef          	jal	51dc <printf>
      exit(1);
     6da:	4505                	li	a0,1
...
00000000000006e0 <truncate1>:
{
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     72c:	cf850513          	addi	a0,a0,-776 # 5420 <malloc+0x190>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     750:	cd450513          	addi	a0,a0,-812 # 5420 <malloc+0x190>
     754:	660040ef          	jal	4db4 <open>
     758:	89aa                	mv	s3,a0
  int fd3 = open("truncfile", O_RDONLY);
     75a:	4581                	li	a1,0
     75c:	00005517          	auipc	a0,0x5
     760:	cc450513          	addi	a0,a0,-828 # 5420 <malloc+0x190>
  ...
  write(fd1, "abcdef", 6);
     ...
     792:	f0a58593          	addi	a1,a1,-246 # 5698 <malloc+0x408>
     796:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     7c8:	c5c50513          	addi	a0,a0,-932 # 5420 <malloc+0x190>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     7fc:	e4050513          	addi	a0,a0,-448 # 5638 <malloc+0x3a8>
     800:	1dd040ef          	jal	51dc <printf>
    exit(1);
     804:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     810:	e4c50513          	addi	a0,a0,-436 # 5658 <malloc+0x3c8>
     814:	1c9040ef          	jal	51dc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     818:	8652                	mv	a2,s4
     81a:	85d6                	mv	a1,s5
     81c:	00005517          	auipc	a0,0x5
     820:	e4c50513          	addi	a0,a0,-436 # 5668 <malloc+0x3d8>
     824:	1b9040ef          	jal	51dc <printf>
    exit(1);
     828:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     834:	e5850513          	addi	a0,a0,-424 # 5688 <malloc+0x3f8>
     838:	1a5040ef          	jal	51dc <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     83c:	8652                	mv	a2,s4
     83e:	85d6                	mv	a1,s5
     840:	00005517          	auipc	a0,0x5
     844:	e2850513          	addi	a0,a0,-472 # 5668 <malloc+0x3d8>
     848:	195040ef          	jal	51dc <printf>
    exit(1);
     84c:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     85a:	e4a50513          	addi	a0,a0,-438 # 56a0 <malloc+0x410>
     85e:	17f040ef          	jal	51dc <printf>
    exit(1);
     862:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     870:	e5450513          	addi	a0,a0,-428 # 56c0 <malloc+0x430>
     874:	169040ef          	jal	51dc <printf>
    exit(1);
     878:	4505                	li	a0,1
...
000000000000087e <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     89c:	e4850513          	addi	a0,a0,-440 # 56e0 <malloc+0x450>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     8b0:	e5c98993          	addi	s3,s3,-420 # 5708 <malloc+0x478>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     8b4:	00005a97          	auipc	s5,0x5
     8b8:	e8ca8a93          	addi	s5,s5,-372 # 5740 <malloc+0x4b0>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     8f2:	df250513          	addi	a0,a0,-526 # 56e0 <malloc+0x450>
  ...
  if(unlink("small") < 0){
     ...
     922:	dc250513          	addi	a0,a0,-574 # 56e0 <malloc+0x450>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     948:	da450513          	addi	a0,a0,-604 # 56e8 <malloc+0x458>
     94c:	091040ef          	jal	51dc <printf>
    exit(1);
     950:	4505                	li	a0,1
     ...
     95e:	dbe50513          	addi	a0,a0,-578 # 5718 <malloc+0x488>
     962:	07b040ef          	jal	51dc <printf>
      exit(1);
     966:	4505                	li	a0,1
     ...
     974:	de050513          	addi	a0,a0,-544 # 5750 <malloc+0x4c0>
     978:	065040ef          	jal	51dc <printf>
      exit(1);
     97c:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     988:	df450513          	addi	a0,a0,-524 # 5778 <malloc+0x4e8>
     98c:	051040ef          	jal	51dc <printf>
    exit(1);
     990:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     99c:	e0050513          	addi	a0,a0,-512 # 5798 <malloc+0x508>
     9a0:	03d040ef          	jal	51dc <printf>
    exit(1);
     9a4:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     9b0:	e0450513          	addi	a0,a0,-508 # 57b0 <malloc+0x520>
     9b4:	029040ef          	jal	51dc <printf>
    exit(1);
     9b8:	4505                	li	a0,1
...
00000000000009be <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9da:	dfa50513          	addi	a0,a0,-518 # 57d0 <malloc+0x540>
  ...
  fd = open("big", O_RDONLY);
     ...
     a20:	db450513          	addi	a0,a0,-588 # 57d0 <malloc+0x540>
  ...
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a60:	d7c50513          	addi	a0,a0,-644 # 57d8 <malloc+0x548>
     a64:	778040ef          	jal	51dc <printf>
    exit(1);
     a68:	4505                	li	a0,1
     ...
     a76:	d8650513          	addi	a0,a0,-634 # 57f8 <malloc+0x568>
     a7a:	762040ef          	jal	51dc <printf>
      exit(1);
     a7e:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a8a:	d9a50513          	addi	a0,a0,-614 # 5820 <malloc+0x590>
     a8e:	74e040ef          	jal	51dc <printf>
    exit(1);
     a92:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     aaa:	d2a50513          	addi	a0,a0,-726 # 57d0 <malloc+0x540>
     ...
     ad0:	d7450513          	addi	a0,a0,-652 # 5840 <malloc+0x5b0>
     ad4:	708040ef          	jal	51dc <printf>
        exit(1);
     ad8:	4505                	li	a0,1
     ...
     ae6:	d8650513          	addi	a0,a0,-634 # 5868 <malloc+0x5d8>
     aea:	6f2040ef          	jal	51dc <printf>
      exit(1);
     aee:	4505                	li	a0,1
     ...
     afc:	d8850513          	addi	a0,a0,-632 # 5880 <malloc+0x5f0>
     b00:	6dc040ef          	jal	51dc <printf>
      exit(1);
     b04:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b10:	d9c50513          	addi	a0,a0,-612 # 58a8 <malloc+0x618>
     b14:	6c8040ef          	jal	51dc <printf>
    exit(1);
     b18:	4505                	li	a0,1
...
0000000000000b1e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b36:	d8e50513          	addi	a0,a0,-626 # 58c0 <malloc+0x630>
  ...
  write(fd, "hello", SZ);
     ...
     b4a:	daa58593          	addi	a1,a1,-598 # 58f0 <malloc+0x660>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     b5e:	d6650513          	addi	a0,a0,-666 # 58c0 <malloc+0x630>
  ...
  unlink("unlinkread");
     ...
     be6:	cde50513          	addi	a0,a0,-802 # 58c0 <malloc+0x630>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c02:	cd250513          	addi	a0,a0,-814 # 58d0 <malloc+0x640>
     c06:	5d6040ef          	jal	51dc <printf>
    exit(1);
     c0a:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c16:	ce650513          	addi	a0,a0,-794 # 58f8 <malloc+0x668>
     c1a:	5c2040ef          	jal	51dc <printf>
    exit(1);
     c1e:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     c2a:	cf250513          	addi	a0,a0,-782 # 5918 <malloc+0x688>
     c2e:	5ae040ef          	jal	51dc <printf>
    exit(1);
     c32:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     c3e:	d0650513          	addi	a0,a0,-762 # 5940 <malloc+0x6b0>
     c42:	59a040ef          	jal	51dc <printf>
    exit(1);
     c46:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     c52:	d1250513          	addi	a0,a0,-750 # 5960 <malloc+0x6d0>
     c56:	586040ef          	jal	51dc <printf>
    exit(1);
     c5a:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     c66:	d1e50513          	addi	a0,a0,-738 # 5980 <malloc+0x6f0>
     c6a:	572040ef          	jal	51dc <printf>
    exit(1);
     c6e:	4505                	li	a0,1
...
0000000000000c74 <linktest>:
{
  ...
  unlink("lf1");
     ...
     c86:	d1e50513          	addi	a0,a0,-738 # 59a0 <malloc+0x710>
     c8a:	13a040ef          	jal	4dc4 <unlink>
  unlink("lf2");
     c8e:	00005517          	auipc	a0,0x5
     c92:	d1a50513          	addi	a0,a0,-742 # 59a8 <malloc+0x718>
     c96:	12e040ef          	jal	4dc4 <unlink>
  fd = open("lf1", O_CREATE|O_RDWR);
     c9a:	20200593          	li	a1,514
     c9e:	00005517          	auipc	a0,0x5
     ca2:	d0250513          	addi	a0,a0,-766 # 59a0 <malloc+0x710>
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     cb6:	c3e58593          	addi	a1,a1,-962 # 58f0 <malloc+0x660>
  ...
  if(link(".", "lf1") >= 0){
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     d8e:	c2650513          	addi	a0,a0,-986 # 59b0 <malloc+0x720>
     d92:	44a040ef          	jal	51dc <printf>
    exit(1);
     d96:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     da2:	c2a50513          	addi	a0,a0,-982 # 59c8 <malloc+0x738>
     da6:	436040ef          	jal	51dc <printf>
    exit(1);
     daa:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     db6:	c2e50513          	addi	a0,a0,-978 # 59e0 <malloc+0x750>
     dba:	422040ef          	jal	51dc <printf>
    exit(1);
     dbe:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     dca:	c3a50513          	addi	a0,a0,-966 # 5a00 <malloc+0x770>
     dce:	40e040ef          	jal	51dc <printf>
    exit(1);
     dd2:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     dde:	c5650513          	addi	a0,a0,-938 # 5a30 <malloc+0x7a0>
     de2:	3fa040ef          	jal	51dc <printf>
    exit(1);
     de6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     df2:	c5a50513          	addi	a0,a0,-934 # 5a48 <malloc+0x7b8>
     df6:	3e6040ef          	jal	51dc <printf>
    exit(1);
     dfa:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     e06:	c5e50513          	addi	a0,a0,-930 # 5a60 <malloc+0x7d0>
     e0a:	3d2040ef          	jal	51dc <printf>
    exit(1);
     e0e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     e1a:	c7250513          	addi	a0,a0,-910 # 5a88 <malloc+0x7f8>
     e1e:	3be040ef          	jal	51dc <printf>
    exit(1);
     e22:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     e2e:	c8e50513          	addi	a0,a0,-882 # 5ab8 <malloc+0x828>
     e32:	3aa040ef          	jal	51dc <printf>
    exit(1);
     e36:	4505                	li	a0,1
...
0000000000000e3c <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    if(link("nosuchfile", (char*)p) != -1){
     ...
     e58:	c8498993          	addi	s3,s3,-892 # 5ad8 <malloc+0x848>
     e5c:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     e5e:	6a85                	lui	s5,0x1
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
     ...
     e90:	c5c50513          	addi	a0,a0,-932 # 5ae8 <malloc+0x858>
     e94:	348040ef          	jal	51dc <printf>
      exit(1);
     e98:	4505                	li	a0,1
...
0000000000000e9e <bigdir>:
{
  ...
  unlink("bd");
     ...
     eb8:	c5450513          	addi	a0,a0,-940 # 5b08 <malloc+0x878>
     ebc:	709030ef          	jal	4dc4 <unlink>
  fd = open("bd", O_CREATE);
     ec0:	20000593          	li	a1,512
     ec4:	00005517          	auipc	a0,0x5
     ec8:	c4450513          	addi	a0,a0,-956 # 5b08 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     ee2:	c2aa0a13          	addi	s4,s4,-982 # 5b08 <malloc+0x878>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
     ...
     f30:	bdc50513          	addi	a0,a0,-1060 # 5b08 <malloc+0x878>
  ...
  for(i = 0; i < N; i++){
    ...
    printf("%s: bigdir create failed\n", s);
     ...
     f98:	b7c50513          	addi	a0,a0,-1156 # 5b10 <malloc+0x880>
     f9c:	240040ef          	jal	51dc <printf>
    exit(1);
     fa0:	4505                	li	a0,1
     ...
     fb2:	b8250513          	addi	a0,a0,-1150 # 5b30 <malloc+0x8a0>
     fb6:	226040ef          	jal	51dc <printf>
      exit(1);
     fba:	4505                	li	a0,1
     ...
     fc6:	b9650513          	addi	a0,a0,-1130 # 5b58 <malloc+0x8c8>
     fca:	212040ef          	jal	51dc <printf>
      exit(1);
     fce:	4505                	li	a0,1
...
0000000000001000 <badarg>:
{
    ...
    101e:	3ae98993          	addi	s3,s3,942 # 53c8 <malloc+0x138>
    argv[0] = (char*)0xffffffff;
...
000000000000103e <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1094:	c1878793          	addi	a5,a5,-1000 # 6ca8 <malloc+0x1a18>
  ...
  if(pid == 0){
    ...
    10e8:	82c78793          	addi	a5,a5,-2004 # 7910 <malloc+0x2680>
    ...
    110c:	2c050513          	addi	a0,a0,704 # 53c8 <malloc+0x138>
    ...
    1120:	ae450513          	addi	a0,a0,-1308 # 5c00 <malloc+0x970>
    1124:	0b8040ef          	jal	51dc <printf>
      exit(1);
    1128:	4505                	li	a0,1
    ...
    1138:	a4450513          	addi	a0,a0,-1468 # 5b78 <malloc+0x8e8>
    113c:	0a0040ef          	jal	51dc <printf>
    exit(1);
    1140:	4505                	li	a0,1
    ...
    1150:	a4c50513          	addi	a0,a0,-1460 # 5b98 <malloc+0x908>
    1154:	088040ef          	jal	51dc <printf>
    exit(1);
    1158:	4505                	li	a0,1
    ...
    116a:	a5250513          	addi	a0,a0,-1454 # 5bb8 <malloc+0x928>
    116e:	06e040ef          	jal	51dc <printf>
    exit(1);
    1172:	4505                	li	a0,1
    ...
    1182:	a6250513          	addi	a0,a0,-1438 # 5be0 <malloc+0x950>
    1186:	056040ef          	jal	51dc <printf>
    exit(1);
    118a:	4505                	li	a0,1
    118c:	3e9030ef          	jal	4d74 <exit>
    printf("fork failed\n");
    1190:	00006517          	auipc	a0,0x6
    1194:	07050513          	addi	a0,a0,112 # 7200 <malloc+0x1f70>
    1198:	044040ef          	jal	51dc <printf>
    exit(1);
    119c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    11ce:	a5e50513          	addi	a0,a0,-1442 # 5c28 <malloc+0x998>
    11d2:	00a040ef          	jal	51dc <printf>
    exit(1);
    11d6:	4505                	li	a0,1
...
00000000000011dc <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    11f0:	23450513          	addi	a0,a0,564 # 5420 <malloc+0x190>
  ...
  if(pid == 0){
    ...
    1216:	20ea0a13          	addi	s4,s4,526 # 5420 <malloc+0x190>
      int n = write(fd, "1234567890", 10);
    121a:	00005a97          	auipc	s5,0x5
    121e:	a6ea8a93          	addi	s5,s5,-1426 # 5c88 <malloc+0x9f8>
      int fd = open("truncfile", O_WRONLY);
    1222:	4585                	li	a1,1
    1224:	8552                	mv	a0,s4
    ...
    127a:	9e250513          	addi	a0,a0,-1566 # 5c58 <malloc+0x9c8>
    127e:	75f030ef          	jal	51dc <printf>
    exit(1);
    1282:	4505                	li	a0,1
    ...
    128e:	9e650513          	addi	a0,a0,-1562 # 5c70 <malloc+0x9e0>
    1292:	74b030ef          	jal	51dc <printf>
        exit(1);
    1296:	4505                	li	a0,1
    ...
    12a4:	9f850513          	addi	a0,a0,-1544 # 5c98 <malloc+0xa08>
    12a8:	735030ef          	jal	51dc <printf>
        exit(1);
    12ac:	4505                	li	a0,1
    ...
    12c2:	162a0a13          	addi	s4,s4,354 # 5420 <malloc+0x190>
    int n = write(fd, "xxx", 3);
    12c6:	00005a97          	auipc	s5,0x5
    12ca:	9f2a8a93          	addi	s5,s5,-1550 # 5cb8 <malloc+0xa28>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1304:	12050513          	addi	a0,a0,288 # 5420 <malloc+0x190>
  ...
  exit(xstatus);
    ...
    131a:	95a50513          	addi	a0,a0,-1702 # 5c70 <malloc+0x9e0>
    131e:	6bf030ef          	jal	51dc <printf>
      exit(1);
    1322:	4505                	li	a0,1
    ...
    1330:	99450513          	addi	a0,a0,-1644 # 5cc0 <malloc+0xa30>
    1334:	6a9030ef          	jal	51dc <printf>
      exit(1);
    1338:	4505                	li	a0,1
...
000000000000133e <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    134e:	07e78793          	addi	a5,a5,126 # 53c8 <malloc+0x138>
    1352:	fcf43023          	sd	a5,-64(s0)
    1356:	00005797          	auipc	a5,0x5
    135a:	98a78793          	addi	a5,a5,-1654 # 5ce0 <malloc+0xa50>
    135e:	fcf43423          	sd	a5,-56(s0)
    1362:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    1366:	00005517          	auipc	a0,0x5
    136a:	98250513          	addi	a0,a0,-1662 # 5ce8 <malloc+0xa58>
  ...
  if(pid == 0) {
    ...
    138e:	95e50513          	addi	a0,a0,-1698 # 5ce8 <malloc+0xa58>
    ...
    13a6:	96650513          	addi	a0,a0,-1690 # 5d08 <malloc+0xa78>
    13aa:	633030ef          	jal	51dc <printf>
      exit(1);
    13ae:	4505                	li	a0,1
    ...
    13bc:	8a050513          	addi	a0,a0,-1888 # 5c58 <malloc+0x9c8>
    13c0:	61d030ef          	jal	51dc <printf>
     exit(1);
    13c4:	4505                	li	a0,1
    ...
    13d0:	92450513          	addi	a0,a0,-1756 # 5cf0 <malloc+0xa60>
    13d4:	609030ef          	jal	51dc <printf>
      exit(1);
    13d8:	4505                	li	a0,1
    ...
    13e6:	fe650513          	addi	a0,a0,-26 # 53c8 <malloc+0x138>
  ...
  if(xstatus != 0)
    ...
    140e:	90e50513          	addi	a0,a0,-1778 # 5d18 <malloc+0xa88>
    1412:	5cb030ef          	jal	51dc <printf>
      exit(1);
    1416:	4505                	li	a0,1
    ...
    1422:	91250513          	addi	a0,a0,-1774 # 5d30 <malloc+0xaa0>
    1426:	5b7030ef          	jal	51dc <printf>
    142a:	bfd1                	j	13fe <exectest+0xc0>
  fd = open("echo-ok", O_RDONLY);
    142c:	4581                	li	a1,0
    142e:	00005517          	auipc	a0,0x5
    1432:	8ba50513          	addi	a0,a0,-1862 # 5ce8 <malloc+0xa58>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    1454:	34850513          	addi	a0,a0,840 # 5798 <malloc+0x508>
    1458:	585030ef          	jal	51dc <printf>
    exit(1);
    145c:	4505                	li	a0,1
    ...
    1468:	80c50513          	addi	a0,a0,-2036 # 5c70 <malloc+0x9e0>
    146c:	571030ef          	jal	51dc <printf>
    exit(1);
    1470:	4505                	li	a0,1
    1472:	103030ef          	jal	4d74 <exit>
  unlink("echo-ok");
    1476:	00005517          	auipc	a0,0x5
    147a:	87250513          	addi	a0,a0,-1934 # 5ce8 <malloc+0xa58>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    14a0:	8ac50513          	addi	a0,a0,-1876 # 5d48 <malloc+0xab8>
    14a4:	539030ef          	jal	51dc <printf>
    exit(1);
    14a8:	4505                	li	a0,1
...
00000000000014b4 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    154c:	81850513          	addi	a0,a0,-2024 # 5d60 <malloc+0xad0>
    1550:	48d030ef          	jal	51dc <printf>
    exit(1);
    1554:	4505                	li	a0,1
    ...
    1582:	42da8a93          	addi	s5,s5,1069 # 142d <exectest+0xef>
{
    ...
    15c6:	7b650513          	addi	a0,a0,1974 # 5d78 <malloc+0xae8>
    15ca:	413030ef          	jal	51dc <printf>
        exit(1);
    15ce:	4505                	li	a0,1
    ...
    15da:	7ba50513          	addi	a0,a0,1978 # 5d90 <malloc+0xb00>
    15de:	3ff030ef          	jal	51dc <printf>
          return;
    ...
    160a:	7a250513          	addi	a0,a0,1954 # 5da8 <malloc+0xb18>
    160e:	3cf030ef          	jal	51dc <printf>
      exit(1);
    1612:	4505                	li	a0,1
    ...
    1642:	78a50513          	addi	a0,a0,1930 # 5dc8 <malloc+0xb38>
    1646:	397030ef          	jal	51dc <printf>
    exit(1);
    164a:	4505                	li	a0,1
...
0000000000001650 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    16a4:	5b850513          	addi	a0,a0,1464 # 5c58 <malloc+0x9c8>
    16a8:	335030ef          	jal	51dc <printf>
      exit(1);
    16ac:	4505                	li	a0,1
    ...
    16b8:	72c50513          	addi	a0,a0,1836 # 5de0 <malloc+0xb50>
    16bc:	321030ef          	jal	51dc <printf>
        exit(1);
    16c0:	4505                	li	a0,1
    ...
    16cc:	73050513          	addi	a0,a0,1840 # 5df8 <malloc+0xb68>
    16d0:	30d030ef          	jal	51dc <printf>
        exit(1);
    16d4:	4505                	li	a0,1
...
00000000000016e0 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1728:	53450513          	addi	a0,a0,1332 # 5c58 <malloc+0x9c8>
    172c:	2b1030ef          	jal	51dc <printf>
      exit(1);
    1730:	4505                	li	a0,1
    ...
    1740:	51c50513          	addi	a0,a0,1308 # 5c58 <malloc+0x9c8>
    1744:	299030ef          	jal	51dc <printf>
        exit(1);
    1748:	4505                	li	a0,1
...
0000000000001752 <forkfork>:
{
    ...
    179e:	67e50513          	addi	a0,a0,1662 # 5e18 <malloc+0xb88>
    17a2:	23b030ef          	jal	51dc <printf>
      exit(1);
    17a6:	4505                	li	a0,1
    17a8:	5cc030ef          	jal	4d74 <exit>
{
    ...
    17da:	65250513          	addi	a0,a0,1618 # 5e28 <malloc+0xb98>
    17de:	1ff030ef          	jal	51dc <printf>
      exit(1);
    17e2:	4505                	li	a0,1
...
00000000000017e8 <reparent2>:
{
  ...
  exit(0);
    ...
    1814:	9f050513          	addi	a0,a0,-1552 # 7200 <malloc+0x1f70>
    1818:	1c5030ef          	jal	51dc <printf>
      exit(1);
    181c:	4505                	li	a0,1
...
0000000000001830 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1896:	3c650513          	addi	a0,a0,966 # 5c58 <malloc+0x9c8>
    189a:	143030ef          	jal	51dc <printf>
      exit(1);
    189e:	4505                	li	a0,1
    ...
    18ba:	43a50513          	addi	a0,a0,1082 # 5cf0 <malloc+0xa60>
    18be:	11f030ef          	jal	51dc <printf>
          exit(1);
    18c2:	4505                	li	a0,1
    ...
    1918:	53450513          	addi	a0,a0,1332 # 5e48 <malloc+0xbb8>
    191c:	0c1030ef          	jal	51dc <printf>
            exit(1);
    1920:	4505                	li	a0,1
    ...
    193c:	52850513          	addi	a0,a0,1320 # 5e60 <malloc+0xbd0>
    1940:	09d030ef          	jal	51dc <printf>
        exit(1);
    1944:	4505                	li	a0,1
    ...
    198e:	4fe50513          	addi	a0,a0,1278 # 5e88 <malloc+0xbf8>
    1992:	04b030ef          	jal	51dc <printf>
        exit(1);
    1996:	4505                	li	a0,1
...
0000000000001a08 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1a28:	a1450513          	addi	a0,a0,-1516 # 5438 <malloc+0x1a8>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1a5c:	9e0b0b13          	addi	s6,s6,-1568 # 5438 <malloc+0x1a8>
      link("cat", "x");
    1a60:	00004c17          	auipc	s8,0x4
    1a64:	450c0c13          	addi	s8,s8,1104 # 5eb0 <malloc+0xc20>
    1a68:	a025                	j	1a90 <linkunlink+0x88>
    printf("%s: fork failed\n", s);
    1a6a:	85a6                	mv	a1,s1
    1a6c:	00004517          	auipc	a0,0x4
    1a70:	1ec50513          	addi	a0,a0,492 # 5c58 <malloc+0x9c8>
    1a74:	768030ef          	jal	51dc <printf>
    exit(1);
    1a78:	4505                	li	a0,1
...
0000000000001ae4 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    1b10:	3f450513          	addi	a0,a0,1012 # 5f00 <malloc+0xc70>
    1b14:	6c8030ef          	jal	51dc <printf>
    exit(1);
    1b18:	4505                	li	a0,1
    ...
    1b28:	39450513          	addi	a0,a0,916 # 5eb8 <malloc+0xc28>
    1b2c:	6b0030ef          	jal	51dc <printf>
    exit(1);
    1b30:	4505                	li	a0,1
    ...
    1b3c:	39850513          	addi	a0,a0,920 # 5ed0 <malloc+0xc40>
    1b40:	69c030ef          	jal	51dc <printf>
      exit(1);
    1b44:	4505                	li	a0,1
    ...
    1b50:	39c50513          	addi	a0,a0,924 # 5ee8 <malloc+0xc58>
    1b54:	688030ef          	jal	51dc <printf>
    exit(1);
    1b58:	4505                	li	a0,1
...
0000000000001b8c <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    1bee:	06e50513          	addi	a0,a0,110 # 5c58 <malloc+0x9c8>
    1bf2:	5ea030ef          	jal	51dc <printf>
      exit(1);
    1bf6:	4505                	li	a0,1
    ...
    1c08:	32450513          	addi	a0,a0,804 # 5f28 <malloc+0xc98>
    1c0c:	5d0030ef          	jal	51dc <printf>
      exit(1);
    1c10:	4505                	li	a0,1
...
0000000000001c1c <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    1c76:	fe650513          	addi	a0,a0,-26 # 5c58 <malloc+0x9c8>
    1c7a:	562030ef          	jal	51dc <printf>
      exit(1);
    1c7e:	4505                	li	a0,1
    ...
    1c9a:	2b250513          	addi	a0,a0,690 # 5f48 <malloc+0xcb8>
    1c9e:	53e030ef          	jal	51dc <printf>
      exit(1);
    1ca2:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    1cea:	27a50513          	addi	a0,a0,634 # 5f60 <malloc+0xcd0>
    1cee:	4ee030ef          	jal	51dc <printf>
    exit(1);
    1cf2:	4505                	li	a0,1
    ...
    1cfe:	f5e50513          	addi	a0,a0,-162 # 5c58 <malloc+0x9c8>
    1d02:	4da030ef          	jal	51dc <printf>
    exit(1);
    1d06:	4505                	li	a0,1
...
0000000000001d12 <nowrite>:
{
  ...
  uint64 addrs[] = { 0, 0x80000000LL, 0x3fffffe000, 0x3ffffff000, 0x4000000000,
    ...
    1d26:	bee78793          	addi	a5,a5,-1042 # 7910 <malloc+0x2680>
  ...
  exit(0);
    ...
    1d8e:	1fe50513          	addi	a0,a0,510 # 5f88 <malloc+0xcf8>
    1d92:	44a030ef          	jal	51dc <printf>
      exit(0);
    1d96:	4501                	li	a0,0
    ...
    1da2:	eba50513          	addi	a0,a0,-326 # 5c58 <malloc+0x9c8>
    1da6:	436030ef          	jal	51dc <printf>
      exit(1);
    1daa:	4505                	li	a0,1
...
0000000000001db6 <manywrites>:
{
  ...
  exit(0);
    ...
    1e0e:	3f650513          	addi	a0,a0,1014 # 7200 <malloc+0x1f70>
    1e12:	3ca030ef          	jal	51dc <printf>
      exit(1);
    1e16:	4505                	li	a0,1
    ...
    1ea0:	10c50513          	addi	a0,a0,268 # 5fa8 <malloc+0xd18>
    1ea4:	338030ef          	jal	51dc <printf>
            exit(1);
    1ea8:	4505                	li	a0,1
    ...
    1eb8:	5e450513          	addi	a0,a0,1508 # 5498 <malloc+0x208>
    1ebc:	320030ef          	jal	51dc <printf>
            exit(1);
    1ec0:	4505                	li	a0,1
...
0000000000001eca <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    1f2c:	d8078793          	addi	a5,a5,-640 # 6ca8 <malloc+0x1a18>
  ...
  if(ret != -1){
    ...
    1f66:	05e50513          	addi	a0,a0,94 # 5fc0 <malloc+0xd30>
    1f6a:	272030ef          	jal	51dc <printf>
    exit(1);
    1f6e:	4505                	li	a0,1
    ...
    1f7c:	c0050513          	addi	a0,a0,-1024 # 5b78 <malloc+0x8e8>
    1f80:	25c030ef          	jal	51dc <printf>
    exit(1);
    1f84:	4505                	li	a0,1
    ...
    1f92:	c0a50513          	addi	a0,a0,-1014 # 5b98 <malloc+0x908>
    1f96:	246030ef          	jal	51dc <printf>
    exit(1);
    1f9a:	4505                	li	a0,1
    ...
    1faa:	c1250513          	addi	a0,a0,-1006 # 5bb8 <malloc+0x928>
    1fae:	22e030ef          	jal	51dc <printf>
    exit(1);
    1fb2:	4505                	li	a0,1
    ...
    1fc0:	c2450513          	addi	a0,a0,-988 # 5be0 <malloc+0x950>
    1fc4:	218030ef          	jal	51dc <printf>
    exit(1);
    1fc8:	4505                	li	a0,1
...
0000000000001fce <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    1ffc:	00850513          	addi	a0,a0,8 # 6000 <malloc+0xd70>
  ...
  if(n >= 0){
    ...
    2024:	00050513          	mv	a0,a0
    2028:	1b4030ef          	jal	51dc <printf>
    exit(1);
    202c:	4505                	li	a0,1
    ...
    203a:	f9250513          	addi	a0,a0,-110 # 5fc8 <malloc+0xd38>
    203e:	19e030ef          	jal	51dc <printf>
    exit(1);
    2042:	4505                	li	a0,1
    ...
    204e:	f9650513          	addi	a0,a0,-106 # 5fe0 <malloc+0xd50>
    2052:	18a030ef          	jal	51dc <printf>
    exit(1);
    2056:	4505                	li	a0,1
    2058:	51d020ef          	jal	4d74 <exit>
    printf("open(rwsbrk) failed\n");
    205c:	00004517          	auipc	a0,0x4
    2060:	fac50513          	addi	a0,a0,-84 # 6008 <malloc+0xd78>
    2064:	178030ef          	jal	51dc <printf>
    exit(1);
    2068:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    2078:	f8c50513          	addi	a0,a0,-116 # 6000 <malloc+0xd70>
    207c:	549020ef          	jal	4dc4 <unlink>
  fd = open("README", O_RDONLY);
    2080:	4581                	li	a1,0
    2082:	00003517          	auipc	a0,0x3
    2086:	51e50513          	addi	a0,a0,1310 # 55a0 <malloc+0x310>
  ...
  if(n >= 0){
    ...
    20a8:	fac50513          	addi	a0,a0,-84 # 6050 <malloc+0xdc0>
    20ac:	130030ef          	jal	51dc <printf>
    exit(1);
    20b0:	4505                	li	a0,1
    20b2:	4c3020ef          	jal	4d74 <exit>
    printf("open(README) failed\n");
    20b6:	00003517          	auipc	a0,0x3
    20ba:	4f250513          	addi	a0,a0,1266 # 55a8 <malloc+0x318>
    20be:	11e030ef          	jal	51dc <printf>
    exit(1);
    20c2:	4505                	li	a0,1
...
00000000000020d4 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2124:	f5850513          	addi	a0,a0,-168 # 6078 <malloc+0xde8>
    2128:	0b4030ef          	jal	51dc <printf>
    exit(1);
    212c:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2174:	f2850513          	addi	a0,a0,-216 # 6098 <malloc+0xe08>
    2178:	064030ef          	jal	51dc <printf>
    exit(1);
    217c:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    21c0:	f3c50513          	addi	a0,a0,-196 # 60f8 <malloc+0xe68>
    21c4:	018030ef          	jal	51dc <printf>
    exit(1);
    21c8:	4505                	li	a0,1
    ...
    21da:	ee250513          	addi	a0,a0,-286 # 60b8 <malloc+0xe28>
    21de:	7ff020ef          	jal	51dc <printf>
      exit(1);
    21e2:	4505                	li	a0,1
    ...
    21ee:	eee50513          	addi	a0,a0,-274 # 60d8 <malloc+0xe48>
    21f2:	7eb020ef          	jal	51dc <printf>
    exit(1);
    21f6:	4505                	li	a0,1
...
0000000000002216 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    22d6:	e4650513          	addi	a0,a0,-442 # 6118 <malloc+0xe88>
    22da:	703020ef          	jal	51dc <printf>
    exit(1);
    22de:	4505                	li	a0,1
    ...
    22ea:	e7a50513          	addi	a0,a0,-390 # 6160 <malloc+0xed0>
    22ee:	6ef020ef          	jal	51dc <printf>
    exit(1);
    22f2:	4505                	li	a0,1
    ...
    2302:	e8250513          	addi	a0,a0,-382 # 6180 <malloc+0xef0>
    2306:	6d7020ef          	jal	51dc <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    231a:	eaa50513          	addi	a0,a0,-342 # 61c0 <malloc+0xf30>
    231e:	6bf020ef          	jal	51dc <printf>
    exit(1);
    2322:	4505                	li	a0,1
    ...
    232e:	ec650513          	addi	a0,a0,-314 # 61f0 <malloc+0xf60>
    2332:	6ab020ef          	jal	51dc <printf>
    exit(1);
    2336:	4505                	li	a0,1
    ...
    2346:	ee650513          	addi	a0,a0,-282 # 6228 <malloc+0xf98>
    234a:	693020ef          	jal	51dc <printf>
    exit(1);
    234e:	4505                	li	a0,1
...
0000000000002354 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2374:	ee050513          	addi	a0,a0,-288 # 6250 <malloc+0xfc0>
    2378:	23d020ef          	jal	4db4 <open>
    237c:	84aa                	mv	s1,a0
  unlink("sbrk");
    237e:	00004517          	auipc	a0,0x4
    2382:	ed250513          	addi	a0,a0,-302 # 6250 <malloc+0xfc0>
  ...
  if(pipe((int *) a) != 0){
    ...
    23c2:	e9a50513          	addi	a0,a0,-358 # 6258 <malloc+0xfc8>
    23c6:	617020ef          	jal	51dc <printf>
    exit(1);
    23ca:	4505                	li	a0,1
    ...
    23d6:	e9e50513          	addi	a0,a0,-354 # 6270 <malloc+0xfe0>
    23da:	603020ef          	jal	51dc <printf>
    exit(1);
    23de:	4505                	li	a0,1
    ...
    23ea:	97a50513          	addi	a0,a0,-1670 # 5d60 <malloc+0xad0>
    23ee:	5ef020ef          	jal	51dc <printf>
    exit(1);
    23f2:	4505                	li	a0,1
...
00000000000023f8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    240c:	e8050513          	addi	a0,a0,-384 # 6288 <malloc+0xff8>
  ...
  close(fd);
    ...
    2444:	83050513          	addi	a0,a0,-2000 # 5c70 <malloc+0x9e0>
    2448:	595020ef          	jal	51dc <printf>
    exit(1);
    244c:	4505                	li	a0,1
...
0000000000002452 <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    247a:	d8a50513          	addi	a0,a0,-630 # 7200 <malloc+0x1f70>
    247e:	55f020ef          	jal	51dc <printf>
    exit(1);
    2482:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24b4:	d5050513          	addi	a0,a0,-688 # 7200 <malloc+0x1f70>
    24b8:	525020ef          	jal	51dc <printf>
    exit(1);
    24bc:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    24f4:	d1050513          	addi	a0,a0,-752 # 7200 <malloc+0x1f70>
    24f8:	4e5020ef          	jal	51dc <printf>
    exit(1);
    24fc:	4505                	li	a0,1
...
00000000000025de <execout>:
{
  ...
  exit(0);
    ...
    2614:	bf050513          	addi	a0,a0,-1040 # 7200 <malloc+0x1f70>
    2618:	3c5020ef          	jal	51dc <printf>
      exit(1);
    261c:	4505                	li	a0,1
    ...
    2654:	d7850513          	addi	a0,a0,-648 # 53c8 <malloc+0x138>
    2658:	faa43c23          	sd	a0,-72(s0)
    265c:	00003797          	auipc	a5,0x3
    2660:	ddc78793          	addi	a5,a5,-548 # 5438 <malloc+0x1a8>
...
000000000000267a <fourteen>:
{
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    26aa:	c6a50513          	addi	a0,a0,-918 # 6310 <malloc+0x1080>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    26c0:	ccc50513          	addi	a0,a0,-820 # 6388 <malloc+0x10f8>
  ...
  unlink("12345678901234");
    ...
    2744:	b5050513          	addi	a0,a0,-1200 # 6290 <malloc+0x1000>
    2748:	295020ef          	jal	51dc <printf>
    exit(1);
    274c:	4505                	li	a0,1
    ...
    2758:	b8450513          	addi	a0,a0,-1148 # 62d8 <malloc+0x1048>
    275c:	281020ef          	jal	51dc <printf>
    exit(1);
    2760:	4505                	li	a0,1
    ...
    276c:	bd850513          	addi	a0,a0,-1064 # 6340 <malloc+0x10b0>
    2770:	26d020ef          	jal	51dc <printf>
    exit(1);
    2774:	4505                	li	a0,1
    ...
    2780:	c3c50513          	addi	a0,a0,-964 # 63b8 <malloc+0x1128>
    2784:	259020ef          	jal	51dc <printf>
    exit(1);
    2788:	4505                	li	a0,1
    ...
    2794:	c8850513          	addi	a0,a0,-888 # 6418 <malloc+0x1188>
    2798:	245020ef          	jal	51dc <printf>
    exit(1);
    279c:	4505                	li	a0,1
    ...
    27a8:	ccc50513          	addi	a0,a0,-820 # 6470 <malloc+0x11e0>
    27ac:	231020ef          	jal	51dc <printf>
    exit(1);
    27b0:	4505                	li	a0,1
...
00000000000027b6 <diskfull>:
{
  ...
  unlink("diskfulldir");
    ...
    27f0:	cbc50513          	addi	a0,a0,-836 # 64a8 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    281c:	ca050513          	addi	a0,a0,-864 # 64b8 <malloc+0x1228>
    2820:	1bd020ef          	jal	51dc <printf>
      break;
  ...
  if(mkdir("diskfulldir") == 0)
    ...
    2892:	c1a50513          	addi	a0,a0,-998 # 64a8 <malloc+0x1218>
    2896:	546020ef          	jal	4ddc <mkdir>
    289a:	12050063          	beqz	a0,29ba <diskfull+0x204>
  unlink("diskfulldir");
    289e:	00004517          	auipc	a0,0x4
    28a2:	c0a50513          	addi	a0,a0,-1014 # 64a8 <malloc+0x1218>
  ...
  for(fi = 0; done == 0 && '0' + fi < 0177; fi++){
    ...
    29c0:	b1c50513          	addi	a0,a0,-1252 # 64d8 <malloc+0x1248>
    29c4:	019020ef          	jal	51dc <printf>
...
00000000000029ca <iputtest>:
{
  ...
  if(chdir("/") < 0){
    ...
    2a26:	aee50513          	addi	a0,a0,-1298 # 6510 <malloc+0x1280>
    2a2a:	7b2020ef          	jal	51dc <printf>
    exit(1);
    2a2e:	4505                	li	a0,1
    ...
    2a3a:	af250513          	addi	a0,a0,-1294 # 6528 <malloc+0x1298>
    2a3e:	79e020ef          	jal	51dc <printf>
    exit(1);
    2a42:	4505                	li	a0,1
    ...
    2a4e:	b0e50513          	addi	a0,a0,-1266 # 6558 <malloc+0x12c8>
    2a52:	78a020ef          	jal	51dc <printf>
    exit(1);
    2a56:	4505                	li	a0,1
    ...
    2a62:	b2250513          	addi	a0,a0,-1246 # 6580 <malloc+0x12f0>
    2a66:	776020ef          	jal	51dc <printf>
    exit(1);
    2a6a:	4505                	li	a0,1
...
0000000000002a70 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    2ac2:	19a50513          	addi	a0,a0,410 # 5c58 <malloc+0x9c8>
    2ac6:	716020ef          	jal	51dc <printf>
    exit(1);
    2aca:	4505                	li	a0,1
    ...
    2ad6:	a3e50513          	addi	a0,a0,-1474 # 6510 <malloc+0x1280>
    2ada:	702020ef          	jal	51dc <printf>
      exit(1);
    2ade:	4505                	li	a0,1
    ...
    2aea:	ab250513          	addi	a0,a0,-1358 # 6598 <malloc+0x1308>
    2aee:	6ee020ef          	jal	51dc <printf>
      exit(1);
    2af2:	4505                	li	a0,1
    ...
    2afe:	a5e50513          	addi	a0,a0,-1442 # 6558 <malloc+0x12c8>
    2b02:	6da020ef          	jal	51dc <printf>
      exit(1);
    2b06:	4505                	li	a0,1
...
0000000000002b1c <dirtest>:
{
  ...
  if(unlink("dir0") < 0){
    ...
    2b78:	99c50513          	addi	a0,a0,-1636 # 6510 <malloc+0x1280>
    2b7c:	660020ef          	jal	51dc <printf>
    exit(1);
    2b80:	4505                	li	a0,1
    ...
    2b8c:	a3050513          	addi	a0,a0,-1488 # 65b8 <malloc+0x1328>
    2b90:	64c020ef          	jal	51dc <printf>
    exit(1);
    2b94:	4505                	li	a0,1
    ...
    2ba0:	a3c50513          	addi	a0,a0,-1476 # 65d8 <malloc+0x1348>
    2ba4:	638020ef          	jal	51dc <printf>
    exit(1);
    2ba8:	4505                	li	a0,1
    ...
    2bb4:	a4050513          	addi	a0,a0,-1472 # 65f0 <malloc+0x1360>
    2bb8:	624020ef          	jal	51dc <printf>
    exit(1);
    2bbc:	4505                	li	a0,1
...
0000000000002bc2 <subdir>:
{
  ...
  unlink("ff");
    ...
    2bd4:	b6850513          	addi	a0,a0,-1176 # 6738 <malloc+0x14a8>
    2bd8:	1ec020ef          	jal	4dc4 <unlink>
  if(mkdir("dd") != 0){
    2bdc:	00004517          	auipc	a0,0x4
    2be0:	a2c50513          	addi	a0,a0,-1492 # 6608 <malloc+0x1378>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    2bf4:	a3850513          	addi	a0,a0,-1480 # 6628 <malloc+0x1398>
  ...
  write(fd, "ff", 2);
    ...
    2c08:	b3458593          	addi	a1,a1,-1228 # 6738 <malloc+0x14a8>
  ...
  if(unlink("dd") >= 0){
    ...
    2c1a:	9f250513          	addi	a0,a0,-1550 # 6608 <malloc+0x1378>
    2c1e:	1a6020ef          	jal	4dc4 <unlink>
    2c22:	2c055963          	bgez	a0,2ef4 <subdir+0x332>
  if(mkdir("/dd/dd") != 0){
    2c26:	00004517          	auipc	a0,0x4
    2c2a:	a5a50513          	addi	a0,a0,-1446 # 6680 <malloc+0x13f0>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    2c3e:	a6e50513          	addi	a0,a0,-1426 # 66a8 <malloc+0x1418>
  ...
  write(fd, "FF", 2);
    ...
    2c52:	a8a58593          	addi	a1,a1,-1398 # 66d8 <malloc+0x1448>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    2c66:	a7e50513          	addi	a0,a0,-1410 # 66e0 <malloc+0x1450>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    2d4c:	96050513          	addi	a0,a0,-1696 # 66a8 <malloc+0x1418>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    2d60:	b6450513          	addi	a0,a0,-1180 # 68c0 <malloc+0x1630>
  ...
  if(unlink("dd") < 0){
    ...
    2ed2:	74250513          	addi	a0,a0,1858 # 6610 <malloc+0x1380>
    2ed6:	306020ef          	jal	51dc <printf>
    exit(1);
    2eda:	4505                	li	a0,1
    ...
    2ee6:	74e50513          	addi	a0,a0,1870 # 6630 <malloc+0x13a0>
    2eea:	2f2020ef          	jal	51dc <printf>
    exit(1);
    2eee:	4505                	li	a0,1
    ...
    2efa:	75a50513          	addi	a0,a0,1882 # 6650 <malloc+0x13c0>
    2efe:	2de020ef          	jal	51dc <printf>
    exit(1);
    2f02:	4505                	li	a0,1
    ...
    2f0e:	77e50513          	addi	a0,a0,1918 # 6688 <malloc+0x13f8>
    2f12:	2ca020ef          	jal	51dc <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f22:	79a50513          	addi	a0,a0,1946 # 66b8 <malloc+0x1428>
    2f26:	2b6020ef          	jal	51dc <printf>
    exit(1);
    2f2a:	4505                	li	a0,1
    ...
    2f36:	7be50513          	addi	a0,a0,1982 # 66f0 <malloc+0x1460>
    2f3a:	2a2020ef          	jal	51dc <printf>
    exit(1);
    2f3e:	4505                	li	a0,1
    ...
    2f4a:	7ca50513          	addi	a0,a0,1994 # 6710 <malloc+0x1480>
    2f4e:	28e020ef          	jal	51dc <printf>
    exit(1);
    2f52:	4505                	li	a0,1
    ...
    2f5e:	7e650513          	addi	a0,a0,2022 # 6740 <malloc+0x14b0>
    2f62:	27a020ef          	jal	51dc <printf>
    exit(1);
    2f66:	4505                	li	a0,1
    ...
    2f72:	7fa50513          	addi	a0,a0,2042 # 6768 <malloc+0x14d8>
    2f76:	266020ef          	jal	51dc <printf>
    exit(1);
    2f7a:	4505                	li	a0,1
    ...
    2f86:	80650513          	addi	a0,a0,-2042 # 6788 <malloc+0x14f8>
    2f8a:	252020ef          	jal	51dc <printf>
    exit(1);
    2f8e:	4505                	li	a0,1
    ...
    2f9a:	81a50513          	addi	a0,a0,-2022 # 67b0 <malloc+0x1520>
    2f9e:	23e020ef          	jal	51dc <printf>
    exit(1);
    2fa2:	4505                	li	a0,1
    ...
    2fae:	82e50513          	addi	a0,a0,-2002 # 67d8 <malloc+0x1548>
    2fb2:	22a020ef          	jal	51dc <printf>
    exit(1);
    2fb6:	4505                	li	a0,1
    ...
    2fc2:	84a50513          	addi	a0,a0,-1974 # 6808 <malloc+0x1578>
    2fc6:	216020ef          	jal	51dc <printf>
    exit(1);
    2fca:	4505                	li	a0,1
    ...
    2fd6:	86650513          	addi	a0,a0,-1946 # 6838 <malloc+0x15a8>
    2fda:	202020ef          	jal	51dc <printf>
    exit(1);
    2fde:	4505                	li	a0,1
    ...
    2fea:	86a50513          	addi	a0,a0,-1942 # 6850 <malloc+0x15c0>
    2fee:	1ee020ef          	jal	51dc <printf>
    exit(1);
    2ff2:	4505                	li	a0,1
    ...
    2ffe:	87650513          	addi	a0,a0,-1930 # 6870 <malloc+0x15e0>
    3002:	1da020ef          	jal	51dc <printf>
    exit(1);
    3006:	4505                	li	a0,1
    ...
    3012:	88250513          	addi	a0,a0,-1918 # 6890 <malloc+0x1600>
    3016:	1c6020ef          	jal	51dc <printf>
    exit(1);
    301a:	4505                	li	a0,1
    ...
    3026:	8ae50513          	addi	a0,a0,-1874 # 68d0 <malloc+0x1640>
    302a:	1b2020ef          	jal	51dc <printf>
    exit(1);
    302e:	4505                	li	a0,1
    ...
    303a:	8ca50513          	addi	a0,a0,-1846 # 6900 <malloc+0x1670>
    303e:	19e020ef          	jal	51dc <printf>
    exit(1);
    3042:	4505                	li	a0,1
    ...
    304e:	8d650513          	addi	a0,a0,-1834 # 6920 <malloc+0x1690>
    3052:	18a020ef          	jal	51dc <printf>
    exit(1);
    3056:	4505                	li	a0,1
    ...
    3062:	8e250513          	addi	a0,a0,-1822 # 6940 <malloc+0x16b0>
    3066:	176020ef          	jal	51dc <printf>
    exit(1);
    306a:	4505                	li	a0,1
    ...
    3076:	8ee50513          	addi	a0,a0,-1810 # 6960 <malloc+0x16d0>
    307a:	162020ef          	jal	51dc <printf>
    exit(1);
    307e:	4505                	li	a0,1
    ...
    308a:	90a50513          	addi	a0,a0,-1782 # 6990 <malloc+0x1700>
    308e:	14e020ef          	jal	51dc <printf>
    exit(1);
    3092:	4505                	li	a0,1
    ...
    309e:	91e50513          	addi	a0,a0,-1762 # 69b8 <malloc+0x1728>
    30a2:	13a020ef          	jal	51dc <printf>
    exit(1);
    30a6:	4505                	li	a0,1
    ...
    30b2:	93250513          	addi	a0,a0,-1742 # 69e0 <malloc+0x1750>
    30b6:	126020ef          	jal	51dc <printf>
    exit(1);
    30ba:	4505                	li	a0,1
    ...
    30c6:	94650513          	addi	a0,a0,-1722 # 6a08 <malloc+0x1778>
    30ca:	112020ef          	jal	51dc <printf>
    exit(1);
    30ce:	4505                	li	a0,1
    ...
    30da:	95250513          	addi	a0,a0,-1710 # 6a28 <malloc+0x1798>
    30de:	0fe020ef          	jal	51dc <printf>
    exit(1);
    30e2:	4505                	li	a0,1
    ...
    30ee:	95e50513          	addi	a0,a0,-1698 # 6a48 <malloc+0x17b8>
    30f2:	0ea020ef          	jal	51dc <printf>
    exit(1);
    30f6:	4505                	li	a0,1
    ...
    3102:	97250513          	addi	a0,a0,-1678 # 6a70 <malloc+0x17e0>
    3106:	0d6020ef          	jal	51dc <printf>
    exit(1);
    310a:	4505                	li	a0,1
    ...
    3116:	97e50513          	addi	a0,a0,-1666 # 6a90 <malloc+0x1800>
    311a:	0c2020ef          	jal	51dc <printf>
    exit(1);
    311e:	4505                	li	a0,1
    ...
    312a:	98a50513          	addi	a0,a0,-1654 # 6ab0 <malloc+0x1820>
    312e:	0ae020ef          	jal	51dc <printf>
    exit(1);
    3132:	4505                	li	a0,1
    ...
    313e:	99e50513          	addi	a0,a0,-1634 # 6ad8 <malloc+0x1848>
    3142:	09a020ef          	jal	51dc <printf>
    exit(1);
    3146:	4505                	li	a0,1
    ...
    3152:	61a50513          	addi	a0,a0,1562 # 6768 <malloc+0x14d8>
    3156:	086020ef          	jal	51dc <printf>
    exit(1);
    315a:	4505                	li	a0,1
    ...
    3166:	99650513          	addi	a0,a0,-1642 # 6af8 <malloc+0x1868>
    316a:	072020ef          	jal	51dc <printf>
    exit(1);
    316e:	4505                	li	a0,1
    ...
    317a:	9a250513          	addi	a0,a0,-1630 # 6b18 <malloc+0x1888>
    317e:	05e020ef          	jal	51dc <printf>
    exit(1);
    3182:	4505                	li	a0,1
    ...
    318e:	9be50513          	addi	a0,a0,-1602 # 6b48 <malloc+0x18b8>
    3192:	04a020ef          	jal	51dc <printf>
    exit(1);
    3196:	4505                	li	a0,1
    ...
    31a2:	9ca50513          	addi	a0,a0,-1590 # 6b68 <malloc+0x18d8>
    31a6:	036020ef          	jal	51dc <printf>
    exit(1);
    31aa:	4505                	li	a0,1
...
00000000000031b0 <rmdot>:
{
  ...
  if(unlink("dots") != 0){
    ...
    323c:	95050513          	addi	a0,a0,-1712 # 6b88 <malloc+0x18f8>
    3240:	79d010ef          	jal	51dc <printf>
    exit(1);
    3244:	4505                	li	a0,1
    ...
    3250:	95450513          	addi	a0,a0,-1708 # 6ba0 <malloc+0x1910>
    3254:	789010ef          	jal	51dc <printf>
    exit(1);
    3258:	4505                	li	a0,1
    ...
    3264:	95850513          	addi	a0,a0,-1704 # 6bb8 <malloc+0x1928>
    3268:	775010ef          	jal	51dc <printf>
    exit(1);
    326c:	4505                	li	a0,1
    ...
    3278:	95c50513          	addi	a0,a0,-1700 # 6bd0 <malloc+0x1940>
    327c:	761010ef          	jal	51dc <printf>
    exit(1);
    3280:	4505                	li	a0,1
    ...
    328c:	2f850513          	addi	a0,a0,760 # 6580 <malloc+0x12f0>
    3290:	74d010ef          	jal	51dc <printf>
    exit(1);
    3294:	4505                	li	a0,1
    ...
    32a0:	95450513          	addi	a0,a0,-1708 # 6bf0 <malloc+0x1960>
    32a4:	739010ef          	jal	51dc <printf>
    exit(1);
    32a8:	4505                	li	a0,1
    ...
    32b4:	96850513          	addi	a0,a0,-1688 # 6c18 <malloc+0x1988>
    32b8:	725010ef          	jal	51dc <printf>
    exit(1);
    32bc:	4505                	li	a0,1
    ...
    32c8:	97450513          	addi	a0,a0,-1676 # 6c38 <malloc+0x19a8>
    32cc:	711010ef          	jal	51dc <printf>
    exit(1);
    32d0:	4505                	li	a0,1
...
00000000000032d6 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    32ec:	97050513          	addi	a0,a0,-1680 # 6c58 <malloc+0x19c8>
  ...
  if(chdir("dirfile") == 0){
    ...
    3300:	95c50513          	addi	a0,a0,-1700 # 6c58 <malloc+0x19c8>
    3304:	2e1010ef          	jal	4de4 <chdir>
    3308:	c569                	beqz	a0,33d2 <dirfile+0xfc>
  fd = open("dirfile/xx", 0);
    330a:	4581                	li	a1,0
    330c:	00004517          	auipc	a0,0x4
    3310:	99450513          	addi	a0,a0,-1644 # 6ca0 <malloc+0x1a10>
  ...
  fd = open(".", 0);
    ...
    3390:	72450513          	addi	a0,a0,1828 # 5ab0 <malloc+0x820>
    3394:	221010ef          	jal	4db4 <open>
    3398:	84aa                	mv	s1,a0
  if(write(fd, "x", 1) > 0){
    339a:	4605                	li	a2,1
    339c:	00002597          	auipc	a1,0x2
    33a0:	09c58593          	addi	a1,a1,156 # 5438 <malloc+0x1a8>
  ...
  close(fd);
    ...
    33c4:	8a050513          	addi	a0,a0,-1888 # 6c60 <malloc+0x19d0>
    33c8:	615010ef          	jal	51dc <printf>
    exit(1);
    33cc:	4505                	li	a0,1
    ...
    33d8:	8ac50513          	addi	a0,a0,-1876 # 6c80 <malloc+0x19f0>
    33dc:	601010ef          	jal	51dc <printf>
    exit(1);
    33e0:	4505                	li	a0,1
    ...
    33ec:	8c850513          	addi	a0,a0,-1848 # 6cb0 <malloc+0x1a20>
    33f0:	5ed010ef          	jal	51dc <printf>
    exit(1);
    33f4:	4505                	li	a0,1
    ...
    3400:	8b450513          	addi	a0,a0,-1868 # 6cb0 <malloc+0x1a20>
    3404:	5d9010ef          	jal	51dc <printf>
    exit(1);
    3408:	4505                	li	a0,1
    ...
    3414:	8c850513          	addi	a0,a0,-1848 # 6cd8 <malloc+0x1a48>
    3418:	5c5010ef          	jal	51dc <printf>
    exit(1);
    341c:	4505                	li	a0,1
    ...
    3428:	8dc50513          	addi	a0,a0,-1828 # 6d00 <malloc+0x1a70>
    342c:	5b1010ef          	jal	51dc <printf>
    exit(1);
    3430:	4505                	li	a0,1
    ...
    343c:	8f050513          	addi	a0,a0,-1808 # 6d28 <malloc+0x1a98>
    3440:	59d010ef          	jal	51dc <printf>
    exit(1);
    3444:	4505                	li	a0,1
    ...
    3450:	90450513          	addi	a0,a0,-1788 # 6d50 <malloc+0x1ac0>
    3454:	589010ef          	jal	51dc <printf>
    exit(1);
    3458:	4505                	li	a0,1
    ...
    3464:	91050513          	addi	a0,a0,-1776 # 6d70 <malloc+0x1ae0>
    3468:	575010ef          	jal	51dc <printf>
    exit(1);
    346c:	4505                	li	a0,1
    ...
    3478:	92450513          	addi	a0,a0,-1756 # 6d98 <malloc+0x1b08>
    347c:	561010ef          	jal	51dc <printf>
    exit(1);
    3480:	4505                	li	a0,1
...
0000000000003486 <iref>:
{
    ...
    34a4:	910a0a13          	addi	s4,s4,-1776 # 6db0 <malloc+0x1b20>
    mkdir("");
    34a8:	00003497          	auipc	s1,0x3
    34ac:	41048493          	addi	s1,s1,1040 # 68b8 <malloc+0x1628>
    link("README", "");
    34b0:	00002a97          	auipc	s5,0x2
    34b4:	0f0a8a93          	addi	s5,s5,240 # 55a0 <malloc+0x310>
    fd = open("xx", O_CREATE);
    34b8:	00003997          	auipc	s3,0x3
    34bc:	7f098993          	addi	s3,s3,2032 # 6ca8 <malloc+0x1a18>
    34c0:	a835                	j	34fc <iref+0x76>
      printf("%s: mkdir irefd failed\n", s);
    34c2:	85da                	mv	a1,s6
    34c4:	00004517          	auipc	a0,0x4
    34c8:	8f450513          	addi	a0,a0,-1804 # 6db8 <malloc+0x1b28>
    34cc:	511010ef          	jal	51dc <printf>
      exit(1);
    34d0:	4505                	li	a0,1
    ...
    34dc:	8f850513          	addi	a0,a0,-1800 # 6dd0 <malloc+0x1b40>
    34e0:	4fd010ef          	jal	51dc <printf>
      exit(1);
    34e4:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3544:	09098993          	addi	s3,s3,144 # 65d0 <malloc+0x1340>
    unlink("irefd");
    3548:	00004917          	auipc	s2,0x4
    354c:	86890913          	addi	s2,s2,-1944 # 6db0 <malloc+0x1b20>
    chdir("..");
    3550:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3564:	01850513          	addi	a0,a0,24 # 6578 <malloc+0x12e8>
...
0000000000003580 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3590:	85c50513          	addi	a0,a0,-1956 # 6de8 <malloc+0x1b58>
  ...
  if(pid == 0){
    ...
    35ac:	84050513          	addi	a0,a0,-1984 # 6de8 <malloc+0x1b58>
    ...
    35be:	84e50513          	addi	a0,a0,-1970 # 6e08 <malloc+0x1b78>
    35c2:	41b010ef          	jal	51dc <printf>
      exit(1);
    35c6:	4505                	li	a0,1
    ...
    35d2:	82250513          	addi	a0,a0,-2014 # 6df0 <malloc+0x1b60>
    35d6:	407010ef          	jal	51dc <printf>
    exit(1);
    35da:	4505                	li	a0,1
    ...
    35e6:	67650513          	addi	a0,a0,1654 # 5c58 <malloc+0x9c8>
    35ea:	3f3010ef          	jal	51dc <printf>
    exit(1);
    35ee:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3604:	7e850513          	addi	a0,a0,2024 # 6de8 <malloc+0x1b58>
    3608:	7bc010ef          	jal	4dc4 <unlink>
    360c:	c919                	beqz	a0,3622 <openiputtest+0xa2>
    printf("%s: unlink failed\n", s);
    360e:	85a6                	mv	a1,s1
    3610:	00003517          	auipc	a0,0x3
    3614:	83850513          	addi	a0,a0,-1992 # 5e48 <malloc+0xbb8>
    3618:	3c5010ef          	jal	51dc <printf>
    exit(1);
    361c:	4505                	li	a0,1
...
0000000000003632 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3642:	7f250513          	addi	a0,a0,2034 # 6e30 <malloc+0x1ba0>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3662:	7d250513          	addi	a0,a0,2002 # 6e30 <malloc+0x1ba0>
  ...
  pause(10); // one second
    ...
    368a:	79250513          	addi	a0,a0,1938 # 5e18 <malloc+0xb88>
    368e:	34f010ef          	jal	51dc <printf>
    exit(1);
    3692:	4505                	li	a0,1
    3694:	6e0010ef          	jal	4d74 <exit>
      int fd = open("stopforking", 0);
    3698:	00003497          	auipc	s1,0x3
    369c:	79848493          	addi	s1,s1,1944 # 6e30 <malloc+0x1ba0>
    36a0:	4581                	li	a1,0
    36a2:	8526                	mv	a0,s1
    ...
    36bc:	77850513          	addi	a0,a0,1912 # 6e30 <malloc+0x1ba0>
...
00000000000036d0 <killstatus>:
{
  ...
  exit(0);
    ...
    3722:	53a50513          	addi	a0,a0,1338 # 5c58 <malloc+0x9c8>
    3726:	2b7010ef          	jal	51dc <printf>
      exit(1);
    372a:	4505                	li	a0,1
    ...
    373c:	70850513          	addi	a0,a0,1800 # 6e40 <malloc+0x1bb0>
    3740:	29d010ef          	jal	51dc <printf>
       exit(1);
    3744:	4505                	li	a0,1
...
000000000000374a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    3770:	6ac50513          	addi	a0,a0,1708 # 5e18 <malloc+0xb88>
    3774:	269010ef          	jal	51dc <printf>
    exit(1);
    3778:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    3792:	4ca50513          	addi	a0,a0,1226 # 5c58 <malloc+0x9c8>
    3796:	247010ef          	jal	51dc <printf>
    exit(1);
    379a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    37c2:	c7a58593          	addi	a1,a1,-902 # 5438 <malloc+0x1a8>
    ...
    37e4:	47850513          	addi	a0,a0,1144 # 5c58 <malloc+0x9c8>
    37e8:	1f5010ef          	jal	51dc <printf>
     exit(1);
    37ec:	4505                	li	a0,1
    ...
    37f8:	66c50513          	addi	a0,a0,1644 # 6e60 <malloc+0x1bd0>
    37fc:	1e1010ef          	jal	51dc <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    3828:	65450513          	addi	a0,a0,1620 # 6e78 <malloc+0x1be8>
    382c:	1b1010ef          	jal	51dc <printf>
}
  ...
  printf("kill... ");
    ...
    384c:	64850513          	addi	a0,a0,1608 # 6e90 <malloc+0x1c00>
    3850:	18d010ef          	jal	51dc <printf>
  kill(pid1);
    3854:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    386a:	63a50513          	addi	a0,a0,1594 # 6ea0 <malloc+0x1c10>
    386e:	16f010ef          	jal	51dc <printf>
  wait(0);
    3872:	4501                	li	a0,0
...
0000000000003886 <reparent>:
{
  ...
  exit(0);
    ...
    38ca:	39250513          	addi	a0,a0,914 # 5c58 <malloc+0x9c8>
    38ce:	10f010ef          	jal	51dc <printf>
      exit(1);
    38d2:	4505                	li	a0,1
    ...
    38de:	50650513          	addi	a0,a0,1286 # 5de0 <malloc+0xb50>
    38e2:	0fb010ef          	jal	51dc <printf>
        exit(1);
    38e6:	4505                	li	a0,1
...
0000000000003906 <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    3942:	42250513          	addi	a0,a0,1058 # 5d60 <malloc+0xad0>
    3946:	097010ef          	jal	51dc <printf>
    exit(1);
    394a:	4505                	li	a0,1
    ...
    396c:	cc058593          	addi	a1,a1,-832 # 7628 <malloc+0x2398>
    ...
    3988:	52c58593          	addi	a1,a1,1324 # 6eb0 <malloc+0x1c20>
  ...
  c = sbrk(PGSIZE);
    ...
    39da:	4e250513          	addi	a0,a0,1250 # 6eb8 <malloc+0x1c28>
    39de:	7fe010ef          	jal	51dc <printf>
  ...
  if(pid == 0){
    ...
    3a24:	4e850513          	addi	a0,a0,1256 # 6f08 <malloc+0x1c78>
    3a28:	7b4010ef          	jal	51dc <printf>
    exit(1);
    3a2c:	4505                	li	a0,1
    ...
    3a38:	4b450513          	addi	a0,a0,1204 # 6ee8 <malloc+0x1c58>
    3a3c:	7a0010ef          	jal	51dc <printf>
    exit(1);
    3a40:	4505                	li	a0,1
    ...
    3a4c:	21050513          	addi	a0,a0,528 # 5c58 <malloc+0x9c8>
    3a50:	78c010ef          	jal	51dc <printf>
    exit(1);
    3a54:	4505                	li	a0,1
...
0000000000003a8a <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    3ace:	6084                	ld	s1,0(s1)
      free(m1);
    3ad0:	73e010ef          	jal	520e <free>
    while(m1){
    3ad4:	fce5                	bnez	s1,3acc <mem+0x42>
    m1 = malloc(1024*20);
    3ad6:	6515                	lui	a0,0x5
    3ad8:	7b8010ef          	jal	5290 <malloc>
    if(m1 == 0){
    3adc:	c511                	beqz	a0,3ae8 <mem+0x5e>
    free(m1);
    3ade:	730010ef          	jal	520e <free>
    exit(0);
    3ae2:	4501                	li	a0,0
    ...
    3aee:	44e50513          	addi	a0,a0,1102 # 6f38 <malloc+0x1ca8>
    3af2:	6ea010ef          	jal	51dc <printf>
      exit(1);
    3af6:	4505                	li	a0,1
...
0000000000003b02 <sharedfd>:
{
  ...
  unlink("sharedfd");
    ...
    3b12:	44a50513          	addi	a0,a0,1098 # 6f58 <malloc+0x1cc8>
    3b16:	2ae010ef          	jal	4dc4 <unlink>
  fd = open("sharedfd", O_CREATE|O_RDWR);
    3b1a:	20200593          	li	a1,514
    3b1e:	00003517          	auipc	a0,0x3
    3b22:	43a50513          	addi	a0,a0,1082 # 6f58 <malloc+0x1cc8>
  ...
  if(pid == 0) {
    ...
    3b8c:	3e050513          	addi	a0,a0,992 # 6f68 <malloc+0x1cd8>
    3b90:	64c010ef          	jal	51dc <printf>
    exit(1);
    3b94:	4505                	li	a0,1
    ...
    3ba0:	3f450513          	addi	a0,a0,1012 # 6f90 <malloc+0x1d00>
    3ba4:	638010ef          	jal	51dc <printf>
      exit(1);
    3ba8:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    3bd0:	38c50513          	addi	a0,a0,908 # 6f58 <malloc+0x1cc8>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    3c08:	3ac50513          	addi	a0,a0,940 # 6fb0 <malloc+0x1d20>
    3c0c:	5d0010ef          	jal	51dc <printf>
    exit(1);
    3c10:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    3c38:	32450513          	addi	a0,a0,804 # 6f58 <malloc+0x1cc8>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    3c5a:	38250513          	addi	a0,a0,898 # 6fd8 <malloc+0x1d48>
    3c5e:	57e010ef          	jal	51dc <printf>
    exit(1);
    3c62:	4505                	li	a0,1
...
0000000000003c6e <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    3c92:	36278793          	addi	a5,a5,866 # 6ff0 <malloc+0x1d60>
    3c96:	f6f43823          	sd	a5,-144(s0)
    3c9a:	00003797          	auipc	a5,0x3
    3c9e:	35e78793          	addi	a5,a5,862 # 6ff8 <malloc+0x1d68>
    3ca2:	f6f43c23          	sd	a5,-136(s0)
    3ca6:	00003797          	auipc	a5,0x3
    3caa:	35a78793          	addi	a5,a5,858 # 7000 <malloc+0x1d70>
    3cae:	f8f43023          	sd	a5,-128(s0)
    3cb2:	00003797          	auipc	a5,0x3
    3cb6:	35678793          	addi	a5,a5,854 # 7008 <malloc+0x1d78>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3d18:	f4450513          	addi	a0,a0,-188 # 5c58 <malloc+0x9c8>
    3d1c:	4c0010ef          	jal	51dc <printf>
      exit(1);
    3d20:	4505                	li	a0,1
    ...
    3d7a:	f7a50513          	addi	a0,a0,-134 # 5cf0 <malloc+0xa60>
    3d7e:	45e010ef          	jal	51dc <printf>
        exit(1);
    3d82:	4505                	li	a0,1
    3d84:	7f1000ef          	jal	4d74 <exit>
          printf("write failed %d\n", n);
    3d88:	00003517          	auipc	a0,0x3
    3d8c:	28850513          	addi	a0,a0,648 # 7010 <malloc+0x1d80>
    3d90:	44c010ef          	jal	51dc <printf>
          exit(1);
    3d94:	4505                	li	a0,1
    ...
    3da6:	28650513          	addi	a0,a0,646 # 7028 <malloc+0x1d98>
    3daa:	432010ef          	jal	51dc <printf>
          exit(1);
    3dae:	4505                	li	a0,1
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    3e16:	22650513          	addi	a0,a0,550 # 7038 <malloc+0x1da8>
    3e1a:	3c2010ef          	jal	51dc <printf>
      exit(1);
    3e1e:	4505                	li	a0,1
...
0000000000003e42 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    3e70:	1e4b8b93          	addi	s7,s7,484 # 7050 <malloc+0x1dc0>
  for(i = 0; i < N; i++){
    ...
    3eaa:	1b250513          	addi	a0,a0,434 # 7058 <malloc+0x1dc8>
    3eae:	32e010ef          	jal	51dc <printf>
        exit(1);
    3eb2:	4505                	li	a0,1
    ...
    3ec0:	19450513          	addi	a0,a0,404 # 7050 <malloc+0x1dc0>
  ...
  fd = open(".", 0);
    ...
    3ee8:	bcc50513          	addi	a0,a0,-1076 # 5ab0 <malloc+0x820>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    3f58:	12450513          	addi	a0,a0,292 # 7078 <malloc+0x1de8>
    3f5c:	280010ef          	jal	51dc <printf>
        exit(1);
    3f60:	4505                	li	a0,1
    ...
    3f70:	12c50513          	addi	a0,a0,300 # 7098 <malloc+0x1e08>
    3f74:	268010ef          	jal	51dc <printf>
        exit(1);
    3f78:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    3f9c:	12850513          	addi	a0,a0,296 # 70c0 <malloc+0x1e30>
    3fa0:	23c010ef          	jal	51dc <printf>
    exit(1);
    3fa4:	4505                	li	a0,1
    ...
    3fb0:	cac50513          	addi	a0,a0,-852 # 5c58 <malloc+0x9c8>
    3fb4:	228010ef          	jal	51dc <printf>
      exit(1);
    3fb8:	4505                	li	a0,1
...
00000000000040e6 <bigfile>:
{
  ...
  unlink("bigfile.dat");
    ...
    40fe:	ffe50513          	addi	a0,a0,-2 # 70f8 <malloc+0x1e68>
    4102:	4c3000ef          	jal	4dc4 <unlink>
  fd = open("bigfile.dat", O_CREATE | O_RDWR);
    4106:	20200593          	li	a1,514
    410a:	00003517          	auipc	a0,0x3
    410e:	fee50513          	addi	a0,a0,-18 # 70f8 <malloc+0x1e68>
  ...
  fd = open("bigfile.dat", 0);
    ...
    415a:	fa250513          	addi	a0,a0,-94 # 70f8 <malloc+0x1e68>
  ...
  for(i = 0; ; i++){
    ...
    41b6:	f5650513          	addi	a0,a0,-170 # 7108 <malloc+0x1e78>
    41ba:	022010ef          	jal	51dc <printf>
    exit(1);
    41be:	4505                	li	a0,1
    ...
    41ca:	f6250513          	addi	a0,a0,-158 # 7128 <malloc+0x1e98>
    41ce:	00e010ef          	jal	51dc <printf>
      exit(1);
    41d2:	4505                	li	a0,1
    ...
    41de:	f6e50513          	addi	a0,a0,-146 # 7148 <malloc+0x1eb8>
    41e2:	7fb000ef          	jal	51dc <printf>
    exit(1);
    41e6:	4505                	li	a0,1
    ...
    41f2:	f7a50513          	addi	a0,a0,-134 # 7168 <malloc+0x1ed8>
    41f6:	7e7000ef          	jal	51dc <printf>
      exit(1);
    41fa:	4505                	li	a0,1
    ...
    4206:	f8650513          	addi	a0,a0,-122 # 7188 <malloc+0x1ef8>
    420a:	7d3000ef          	jal	51dc <printf>
      exit(1);
    420e:	4505                	li	a0,1
    ...
    421a:	f8a50513          	addi	a0,a0,-118 # 71a0 <malloc+0x1f10>
    421e:	7bf000ef          	jal	51dc <printf>
      exit(1);
    4222:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    423c:	ec050513          	addi	a0,a0,-320 # 70f8 <malloc+0x1e68>
    ...
    425c:	f6850513          	addi	a0,a0,-152 # 71c0 <malloc+0x1f30>
    4260:	77d000ef          	jal	51dc <printf>
    exit(1);
    4264:	4505                	li	a0,1
...
000000000000426a <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    427a:	f6a50513          	addi	a0,a0,-150 # 71e0 <malloc+0x1f50>
  ...
  fd = open("bigarg-ok", 0);
    ...
    42a0:	f4450513          	addi	a0,a0,-188 # 71e0 <malloc+0x1f50>
  ...
  close(fd);
    ...
    42fa:	0d250513          	addi	a0,a0,210 # 53c8 <malloc+0x138>
    42fe:	2af000ef          	jal	4dac <exec>
    fd = open("bigarg-ok", O_CREATE);
    4302:	20000593          	li	a1,512
    4306:	00003517          	auipc	a0,0x3
    430a:	eda50513          	addi	a0,a0,-294 # 71e0 <malloc+0x1f50>
    ...
    4322:	ed250513          	addi	a0,a0,-302 # 71f0 <malloc+0x1f60>
    4326:	6b7000ef          	jal	51dc <printf>
    exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	eda50513          	addi	a0,a0,-294 # 7210 <malloc+0x1f80>
    433e:	69f000ef          	jal	51dc <printf>
    exit(1);
    4342:	4505                	li	a0,1
...
0000000000004348 <lazy_alloc>:
{
  ...
  exit(0);
    ...
    4392:	ea250513          	addi	a0,a0,-350 # 7230 <malloc+0x1fa0>
    4396:	647000ef          	jal	51dc <printf>
    exit(1);
    439a:	4505                	li	a0,1
    439c:	1d9000ef          	jal	4d74 <exit>
      printf("failed to read value from memory\n");
    43a0:	00003517          	auipc	a0,0x3
    43a4:	ea850513          	addi	a0,a0,-344 # 7248 <malloc+0x1fb8>
    43a8:	635000ef          	jal	51dc <printf>
      exit(1);
    43ac:	4505                	li	a0,1
...
00000000000043b2 <lazy_unmap>:
{
  ...
  exit(0);
    ...
    441a:	e1a50513          	addi	a0,a0,-486 # 7230 <malloc+0x1fa0>
    441e:	5bf000ef          	jal	51dc <printf>
    exit(1);
    4422:	4505                	li	a0,1
    4424:	151000ef          	jal	4d74 <exit>
      printf("error forking\n");
    4428:	00003517          	auipc	a0,0x3
    442c:	e4850513          	addi	a0,a0,-440 # 7270 <malloc+0x1fe0>
    4430:	5ad000ef          	jal	51dc <printf>
      exit(1);
    4434:	4505                	li	a0,1
    ...
    4450:	e3450513          	addi	a0,a0,-460 # 7280 <malloc+0x1ff0>
    4454:	589000ef          	jal	51dc <printf>
        exit(1);
    4458:	4505                	li	a0,1
...
000000000000445e <lazy_copy>:
{
    ...
    44a6:	df650513          	addi	a0,a0,-522 # 7298 <malloc+0x2008>
    44aa:	533000ef          	jal	51dc <printf>
      exit(1);
    44ae:	4505                	li	a0,1
    44b0:	0c5000ef          	jal	4d74 <exit>
  unsigned long bad[] = {
    44b4:	00003797          	auipc	a5,0x3
    44b8:	45c78793          	addi	a5,a5,1116 # 7910 <malloc+0x2680>
  ...
  for(int i = 0; i < sizeof(bad)/sizeof(bad[0]); i++){
    ...
    44ec:	0b8a0a13          	addi	s4,s4,184 # 55a0 <malloc+0x310>
    fd = open("junk", O_CREATE|O_RDWR|O_TRUNC);
    44f0:	00001a97          	auipc	s5,0x1
    44f4:	fc0a8a93          	addi	s5,s5,-64 # 54b0 <malloc+0x220>
    int fd = open("README", 0);
    44f8:	4581                	li	a1,0
    44fa:	8552                	mv	a0,s4
  ...
  exit(0);
    ...
    4552:	d7a50513          	addi	a0,a0,-646 # 72c8 <malloc+0x2038>
    4556:	487000ef          	jal	51dc <printf>
    455a:	4505                	li	a0,1
    455c:	019000ef          	jal	4d74 <exit>
    if(read(fd, (char*)bad[i], 512) >= 0) { printf("read succeeded\n");  exit(1); }
    4560:	00003517          	auipc	a0,0x3
    4564:	d8050513          	addi	a0,a0,-640 # 72e0 <malloc+0x2050>
    4568:	475000ef          	jal	51dc <printf>
    456c:	4505                	li	a0,1
    456e:	007000ef          	jal	4d74 <exit>
    if(fd < 0) { printf("cannot open junk\n"); exit(1); }
    4572:	00003517          	auipc	a0,0x3
    4576:	d7e50513          	addi	a0,a0,-642 # 72f0 <malloc+0x2060>
    457a:	463000ef          	jal	51dc <printf>
    457e:	4505                	li	a0,1
    4580:	7f4000ef          	jal	4d74 <exit>
    if(write(fd, (char*)bad[i], 512) >= 0) { printf("write succeeded\n"); exit(1); }
    4584:	00003517          	auipc	a0,0x3
    4588:	d8450513          	addi	a0,a0,-636 # 7308 <malloc+0x2078>
    458c:	451000ef          	jal	51dc <printf>
    4590:	4505                	li	a0,1
...
0000000000004596 <lazy_sbrk>:
{
  ...
  if (p1 < 0 || p1 != p) {
    ...
    45e4:	d4050513          	addi	a0,a0,-704 # 7320 <malloc+0x2090>
    45e8:	3f5000ef          	jal	51dc <printf>
    exit(1);
    45ec:	4505                	li	a0,1
  ...
  if (p < 0 || (uint64)p != TRAPFRAME-PGSIZE) {
    ...
    460c:	d4850513          	addi	a0,a0,-696 # 7350 <malloc+0x20c0>
    4610:	3cd000ef          	jal	51dc <printf>
    exit(1);
    4614:	4505                	li	a0,1
  ...
  if (p[1] != 0) {
    ...
    4632:	d5a50513          	addi	a0,a0,-678 # 7388 <malloc+0x20f8>
    4636:	3a7000ef          	jal	51dc <printf>
    exit(1);
    463a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4652:	d6250513          	addi	a0,a0,-670 # 73b0 <malloc+0x2120>
    4656:	387000ef          	jal	51dc <printf>
    exit(1);
    465a:	4505                	li	a0,1
  ...
  if ((uint64)p != -1) {
    ...
    4672:	d6a50513          	addi	a0,a0,-662 # 73d8 <malloc+0x2148>
    4676:	367000ef          	jal	51dc <printf>
    exit(1);
    467a:	4505                	li	a0,1
...
0000000000004686 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    46a6:	d6650513          	addi	a0,a0,-666 # 7408 <malloc+0x2178>
    46aa:	333000ef          	jal	51dc <printf>
  for(nfiles = 0; ; nfiles++){
    46ae:	4481                	li	s1,0
    name[0] = 'f';
    ...
    46c2:	d5ac8c93          	addi	s9,s9,-678 # 7418 <malloc+0x2188>
    name[0] = 'f';
    ...
    472a:	d0250513          	addi	a0,a0,-766 # 7428 <malloc+0x2198>
    472e:	2af000ef          	jal	51dc <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    4798:	cb450513          	addi	a0,a0,-844 # 7448 <malloc+0x21b8>
    479c:	241000ef          	jal	51dc <printf>
}
    ...
    47e6:	c5650513          	addi	a0,a0,-938 # 7438 <malloc+0x21a8>
    47ea:	1f3000ef          	jal	51dc <printf>
    close(fd);
    47ee:	854a                	mv	a0,s2
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    4810:	c5450513          	addi	a0,a0,-940 # 7460 <malloc+0x21d0>
    4814:	1c9000ef          	jal	51dc <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    4834:	c5850513          	addi	a0,a0,-936 # 7488 <malloc+0x21f8>
    4838:	1a5000ef          	jal	51dc <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    4854:	c2050513          	addi	a0,a0,-992 # 7470 <malloc+0x21e0>
    4858:	185000ef          	jal	51dc <printf>
    exit(1);
    485c:	4505                	li	a0,1
    ...
    4870:	c2450513          	addi	a0,a0,-988 # 7490 <malloc+0x2200>
    4874:	169000ef          	jal	51dc <printf>
...
runtests(struct test *tests, char *justone, int continuous) {
  ...
  for (struct test *t = tests; t->s != 0; t++) {
    ...
    48c2:	bda50513          	addi	a0,a0,-1062 # 7498 <malloc+0x2208>
    48c6:	117000ef          	jal	51dc <printf>
          return -1;
    48ca:	59fd                	li	s3,-1
...
drivetests(int quick, int continuous, char *justone) {
  ...
  do {
    ...
    495a:	b5ac0c13          	addi	s8,s8,-1190 # 74b0 <malloc+0x2220>
    int free0 = countfree();
    int free1 = 0;
    int ntests = 0;
    int n;
    ...
    4974:	b58d8d93          	addi	s11,s11,-1192 # 74c8 <malloc+0x2238>
      } else {
        ntests += n;
      }
    }
    ...
    497c:	b70d0d13          	addi	s10,s10,-1168 # 74e8 <malloc+0x2258>
    ...
    49f6:	b2650513          	addi	a0,a0,-1242 # 7518 <malloc+0x2288>
    49fa:	7e2000ef          	jal	51dc <printf>
      return 1;
    49fe:	4505                	li	a0,1
...
main(int argc, char *argv[])
{
  ...
  if(argc == 2 && strcmp(argv[1], "-q") == 0){
    ...
    4a60:	ad458593          	addi	a1,a1,-1324 # 7530 <malloc+0x22a0>
  ...
  int continuous = 0;
    ...
    4ab4:	a9050513          	addi	a0,a0,-1392 # 7540 <malloc+0x22b0>
    4ab8:	724000ef          	jal	51dc <printf>
    exit(1);
    4abc:	4505                	li	a0,1
  ...
  printf("ALL TESTS PASSED\n");
    ...
    4ad2:	aa250513          	addi	a0,a0,-1374 # 7570 <malloc+0x22e0>
    4ad6:	706000ef          	jal	51dc <printf>
  exit(0);
    4ada:	4501                	li	a0,0
...
putc(int fd, char c)
{
    4e54:	1101                	addi	sp,sp,-32
    4e56:	ec06                	sd	ra,24(sp)
    4e58:	e822                	sd	s0,16(sp)
    4e5a:	1000                	addi	s0,sp,32
    4e5c:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    4e60:	4605                	li	a2,1
    4e62:	fef40593          	addi	a1,s0,-17
    4e66:	f2fff0ef          	jal	4d94 <write>
}
    4e6a:	60e2                	ld	ra,24(sp)
    4e6c:	6442                	ld	s0,16(sp)
    4e6e:	6105                	addi	sp,sp,32
    4e70:	8082                	ret

0000000000004e72 <printint>:

static void
printint(int fd, long long xx, int base, int sgn)
{
    4e72:	715d                	addi	sp,sp,-80
    4e74:	e486                	sd	ra,72(sp)
    4e76:	e0a2                	sd	s0,64(sp)
    4e78:	f84a                	sd	s2,48(sp)
    4e7a:	0880                	addi	s0,sp,80
    4e7c:	892a                	mv	s2,a0
  char buf[20];
  int i, neg;
  ...
  neg = 0;
  if(sgn && xx < 0){
    4e7e:	c299                	beqz	a3,4e84 <printint+0x12>
    4e80:	0805c363          	bltz	a1,4f06 <printint+0x94>
  neg = 0;
    4e84:	4881                	li	a7,0
    4e86:	fb840693          	addi	a3,s0,-72
    x = -xx;
  } else {
    x = xx;
  }
  ...
  do{
    buf[i++] = digits[x % base];
    4e8c:	00003517          	auipc	a0,0x3
    4e90:	b2c50513          	addi	a0,a0,-1236 # 79b8 <digits>
    4e94:	883e                	mv	a6,a5
    4e96:	2785                	addiw	a5,a5,1
    4e98:	02c5f733          	remu	a4,a1,a2
    4e9c:	972a                	add	a4,a4,a0
    4e9e:	00074703          	lbu	a4,0(a4)
    4ea2:	00e68023          	sb	a4,0(a3)
  }while((x /= base) != 0);
    4ea6:	872e                	mv	a4,a1
    4ea8:	02c5d5b3          	divu	a1,a1,a2
    4eac:	0685                	addi	a3,a3,1
    4eae:	fec773e3          	bgeu	a4,a2,4e94 <printint+0x22>
  if(neg)
    4eb2:	00088b63          	beqz	a7,4ec8 <printint+0x56>
    buf[i++] = '-';
    4eb6:	fd078793          	addi	a5,a5,-48
    4eba:	97a2                	add	a5,a5,s0
    4ebc:	02d00713          	li	a4,45
    4ec0:	fee78423          	sb	a4,-24(a5)
    4ec4:	0028079b          	addiw	a5,a6,2

  while(--i >= 0)
    4ec8:	02f05a63          	blez	a5,4efc <printint+0x8a>
    4ecc:	fc26                	sd	s1,56(sp)
    4ece:	f44e                	sd	s3,40(sp)
    4ed0:	fb840713          	addi	a4,s0,-72
    4ed4:	00f704b3          	add	s1,a4,a5
    4ed8:	fff70993          	addi	s3,a4,-1
    4edc:	99be                	add	s3,s3,a5
    4ede:	37fd                	addiw	a5,a5,-1
    4ee0:	1782                	slli	a5,a5,0x20
    4ee2:	9381                	srli	a5,a5,0x20
    4ee4:	40f989b3          	sub	s3,s3,a5
    putc(fd, buf[i]);
    4ee8:	fff4c583          	lbu	a1,-1(s1)
    4eec:	854a                	mv	a0,s2
    4eee:	f67ff0ef          	jal	4e54 <putc>
  while(--i >= 0)
    4ef2:	14fd                	addi	s1,s1,-1
    4ef4:	ff349ae3          	bne	s1,s3,4ee8 <printint+0x76>
    4ef8:	74e2                	ld	s1,56(sp)
    4efa:	79a2                	ld	s3,40(sp)
}
    4efc:	60a6                	ld	ra,72(sp)
    4efe:	6406                	ld	s0,64(sp)
    4f00:	7942                	ld	s2,48(sp)
    4f02:	6161                	addi	sp,sp,80
    4f04:	8082                	ret
    x = -xx;
    4f06:	40b005b3          	neg	a1,a1
    neg = 1;
    4f0a:	4885                	li	a7,1
    x = -xx;
    4f0c:	bfad                	j	4e86 <printint+0x14>

0000000000004f0e <vprintf>:
}
...
{
    4f0e:	711d                	addi	sp,sp,-96
    4f10:	ec86                	sd	ra,88(sp)
    4f12:	e8a2                	sd	s0,80(sp)
    4f14:	e0ca                	sd	s2,64(sp)
    4f16:	1080                	addi	s0,sp,96
  char *s;
  int c0, c1, c2, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    4f18:	0005c903          	lbu	s2,0(a1)
    4f1c:	28090663          	beqz	s2,51a8 <vprintf+0x29a>
    4f20:	e4a6                	sd	s1,72(sp)
    4f22:	fc4e                	sd	s3,56(sp)
    4f24:	f852                	sd	s4,48(sp)
    4f26:	f456                	sd	s5,40(sp)
    4f28:	f05a                	sd	s6,32(sp)
    4f2a:	ec5e                	sd	s7,24(sp)
    4f2c:	e862                	sd	s8,16(sp)
    4f2e:	e466                	sd	s9,8(sp)
    4f30:	8b2a                	mv	s6,a0
    4f32:	8a2e                	mv	s4,a1
    4f34:	8bb2                	mv	s7,a2
  state = 0;
  ...
  for(i = 0; fmt[i]; i++){
    ...
    4f3c:	02500a93          	li	s5,37
      c1 = c2 = 0;
      if(c0) c1 = fmt[i+1] & 0xff;
      if(c1) c2 = fmt[i+2] & 0xff;
      if(c0 == 'd'){
    4f40:	06400c13          	li	s8,100
        printint(fd, va_arg(ap, int), 10, 1);
      } else if(c0 == 'l' && c1 == 'd'){
    4f44:	06c00c93          	li	s9,108
    4f48:	a005                	j	4f68 <vprintf+0x5a>
        putc(fd, c0);
    4f4a:	85ca                	mv	a1,s2
    4f4c:	855a                	mv	a0,s6
    4f4e:	f07ff0ef          	jal	4e54 <putc>
    4f52:	a019                	j	4f58 <vprintf+0x4a>
    } else if(state == '%'){
    4f54:	03598263          	beq	s3,s5,4f78 <vprintf+0x6a>
  for(i = 0; fmt[i]; i++){
    4f58:	2485                	addiw	s1,s1,1
    4f5a:	8726                	mv	a4,s1
    4f5c:	009a07b3          	add	a5,s4,s1
    4f60:	0007c903          	lbu	s2,0(a5)
    4f64:	22090a63          	beqz	s2,5198 <vprintf+0x28a>
    c0 = fmt[i] & 0xff;
    4f68:	0009079b          	sext.w	a5,s2
    if(state == 0){
    4f6c:	fe0994e3          	bnez	s3,4f54 <vprintf+0x46>
      if(c0 == '%'){
    4f70:	fd579de3          	bne	a5,s5,4f4a <vprintf+0x3c>
        state = '%';
    4f74:	89be                	mv	s3,a5
    4f76:	b7cd                	j	4f58 <vprintf+0x4a>
      if(c0) c1 = fmt[i+1] & 0xff;
    4f78:	00ea06b3          	add	a3,s4,a4
    4f7c:	0016c683          	lbu	a3,1(a3)
      c1 = c2 = 0;
    4f80:	8636                	mv	a2,a3
      if(c1) c2 = fmt[i+2] & 0xff;
    4f82:	c681                	beqz	a3,4f8a <vprintf+0x7c>
    4f84:	9752                	add	a4,a4,s4
    4f86:	00274603          	lbu	a2,2(a4)
      if(c0 == 'd'){
    4f8a:	05878363          	beq	a5,s8,4fd0 <vprintf+0xc2>
      } else if(c0 == 'l' && c1 == 'd'){
    4f8e:	05978d63          	beq	a5,s9,4fe8 <vprintf+0xda>
    ...
    4f92:	07500713          	li	a4,117
    4f96:	0ee78763          	beq	a5,a4,5084 <vprintf+0x176>
    ...
    4f9a:	07800713          	li	a4,120
    4f9e:	12e78963          	beq	a5,a4,50d0 <vprintf+0x1c2>
    ...
    4fa2:	07000713          	li	a4,112
    4fa6:	14e78e63          	beq	a5,a4,5102 <vprintf+0x1f4>
        printptr(fd, va_arg(ap, uint64));
      } else if(c0 == 'c'){
    4faa:	06300713          	li	a4,99
    4fae:	18e78e63          	beq	a5,a4,514a <vprintf+0x23c>
        putc(fd, va_arg(ap, uint32));
      } else if(c0 == 's'){
    4fb2:	07300713          	li	a4,115
    4fb6:	1ae78463          	beq	a5,a4,515e <vprintf+0x250>
        if((s = va_arg(ap, char*)) == 0)
          s = "(null)";
        for(; *s; s++)
          putc(fd, *s);
      } else if(c0 == '%'){
    4fba:	02500713          	li	a4,37
    4fbe:	04e79563          	bne	a5,a4,5008 <vprintf+0xfa>
        putc(fd, '%');
    4fc2:	02500593          	li	a1,37
    4fc6:	855a                	mv	a0,s6
    4fc8:	e8dff0ef          	jal	4e54 <putc>
      ...
      state = 0;
    4fcc:	4981                	li	s3,0
    4fce:	b769                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, int), 10, 1);
    4fd0:	008b8913          	addi	s2,s7,8
    4fd4:	4685                	li	a3,1
    4fd6:	4629                	li	a2,10
    4fd8:	000ba583          	lw	a1,0(s7)
    4fdc:	855a                	mv	a0,s6
    4fde:	e95ff0ef          	jal	4e72 <printint>
    4fe2:	8bca                	mv	s7,s2
      state = 0;
    4fe4:	4981                	li	s3,0
    4fe6:	bf8d                	j	4f58 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'd'){
    4fe8:	06400793          	li	a5,100
    4fec:	02f68963          	beq	a3,a5,501e <vprintf+0x110>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    4ff0:	06c00793          	li	a5,108
    4ff4:	04f68263          	beq	a3,a5,5038 <vprintf+0x12a>
      } else if(c0 == 'l' && c1 == 'u'){
    4ff8:	07500793          	li	a5,117
    4ffc:	0af68063          	beq	a3,a5,509c <vprintf+0x18e>
      } else if(c0 == 'l' && c1 == 'x'){
    5000:	07800793          	li	a5,120
    5004:	0ef68263          	beq	a3,a5,50e8 <vprintf+0x1da>
        putc(fd, '%');
    5008:	02500593          	li	a1,37
    500c:	855a                	mv	a0,s6
    500e:	e47ff0ef          	jal	4e54 <putc>
        putc(fd, c0);
    5012:	85ca                	mv	a1,s2
    5014:	855a                	mv	a0,s6
    5016:	e3fff0ef          	jal	4e54 <putc>
      state = 0;
    501a:	4981                	li	s3,0
    501c:	bf35                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    502a:	855a                	mv	a0,s6
    502c:	e47ff0ef          	jal	4e72 <printint>
        i += 1;
    ...
    5034:	4981                	li	s3,0
        i += 1;
    5036:	b70d                	j	4f58 <vprintf+0x4a>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'd'){
    5038:	06400793          	li	a5,100
    503c:	02f60763          	beq	a2,a5,506a <vprintf+0x15c>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'u'){
    5040:	07500793          	li	a5,117
    5044:	06f60963          	beq	a2,a5,50b6 <vprintf+0x1a8>
      } else if(c0 == 'l' && c1 == 'l' && c2 == 'x'){
    5048:	07800793          	li	a5,120
    504c:	faf61ee3          	bne	a2,a5,5008 <vprintf+0xfa>
        printint(fd, va_arg(ap, uint64), 16, 0);
    5050:	008b8913          	addi	s2,s7,8
    5054:	4681                	li	a3,0
    5056:	4641                	li	a2,16
    5058:	000bb583          	ld	a1,0(s7)
    505c:	855a                	mv	a0,s6
    505e:	e15ff0ef          	jal	4e72 <printint>
        i += 2;
    5062:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 16, 0);
    5064:	8bca                	mv	s7,s2
      state = 0;
    5066:	4981                	li	s3,0
        i += 2;
    5068:	bdc5                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 1);
    ...
    5076:	855a                	mv	a0,s6
    5078:	dfbff0ef          	jal	4e72 <printint>
        i += 2;
    507c:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 1);
    507e:	8bca                	mv	s7,s2
      state = 0;
    5080:	4981                	li	s3,0
        i += 2;
    5082:	bdd9                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 10, 0);
    5084:	008b8913          	addi	s2,s7,8
    5088:	4681                	li	a3,0
    508a:	4629                	li	a2,10
    508c:	000be583          	lwu	a1,0(s7)
    5090:	855a                	mv	a0,s6
    5092:	de1ff0ef          	jal	4e72 <printint>
    5096:	8bca                	mv	s7,s2
      state = 0;
    5098:	4981                	li	s3,0
    509a:	bd7d                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    509c:	008b8913          	addi	s2,s7,8
    50a0:	4681                	li	a3,0
    50a2:	4629                	li	a2,10
    50a4:	000bb583          	ld	a1,0(s7)
    50a8:	855a                	mv	a0,s6
    50aa:	dc9ff0ef          	jal	4e72 <printint>
        i += 1;
    ...
    50b2:	4981                	li	s3,0
        i += 1;
    50b4:	b555                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 10, 0);
    50b6:	008b8913          	addi	s2,s7,8
    50ba:	4681                	li	a3,0
    50bc:	4629                	li	a2,10
    50be:	000bb583          	ld	a1,0(s7)
    50c2:	855a                	mv	a0,s6
    50c4:	dafff0ef          	jal	4e72 <printint>
        i += 2;
    50c8:	2489                	addiw	s1,s1,2
        printint(fd, va_arg(ap, uint64), 10, 0);
    50ca:	8bca                	mv	s7,s2
      state = 0;
    50cc:	4981                	li	s3,0
        i += 2;
    50ce:	b569                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint32), 16, 0);
    50d0:	008b8913          	addi	s2,s7,8
    50d4:	4681                	li	a3,0
    50d6:	4641                	li	a2,16
    50d8:	000be583          	lwu	a1,0(s7)
    50dc:	855a                	mv	a0,s6
    50de:	d95ff0ef          	jal	4e72 <printint>
    50e2:	8bca                	mv	s7,s2
      state = 0;
    50e4:	4981                	li	s3,0
    50e6:	bd8d                	j	4f58 <vprintf+0x4a>
        printint(fd, va_arg(ap, uint64), 16, 0);
    50e8:	008b8913          	addi	s2,s7,8
    50ec:	4681                	li	a3,0
    50ee:	4641                	li	a2,16
    50f0:	000bb583          	ld	a1,0(s7)
    50f4:	855a                	mv	a0,s6
    50f6:	d7dff0ef          	jal	4e72 <printint>
        i += 1;
    ...
    50fe:	4981                	li	s3,0
        i += 1;
    5100:	bda1                	j	4f58 <vprintf+0x4a>
    5102:	e06a                	sd	s10,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5104:	008b8d13          	addi	s10,s7,8
    5108:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    510c:	03000593          	li	a1,48
    5110:	855a                	mv	a0,s6
    5112:	d43ff0ef          	jal	4e54 <putc>
  putc(fd, 'x');
    5116:	07800593          	li	a1,120
    511a:	855a                	mv	a0,s6
    511c:	d39ff0ef          	jal	4e54 <putc>
    5120:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5122:	00003b97          	auipc	s7,0x3
    5126:	896b8b93          	addi	s7,s7,-1898 # 79b8 <digits>
    512a:	03c9d793          	srli	a5,s3,0x3c
    512e:	97de                	add	a5,a5,s7
    5130:	0007c583          	lbu	a1,0(a5)
    5134:	855a                	mv	a0,s6
    5136:	d1fff0ef          	jal	4e54 <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    513a:	0992                	slli	s3,s3,0x4
    513c:	397d                	addiw	s2,s2,-1
    513e:	fe0916e3          	bnez	s2,512a <vprintf+0x21c>
        printptr(fd, va_arg(ap, uint64));
    5142:	8bea                	mv	s7,s10
      state = 0;
    5144:	4981                	li	s3,0
    5146:	6d02                	ld	s10,0(sp)
    5148:	bd01                	j	4f58 <vprintf+0x4a>
        putc(fd, va_arg(ap, uint32));
    514a:	008b8913          	addi	s2,s7,8
    514e:	000bc583          	lbu	a1,0(s7)
    5152:	855a                	mv	a0,s6
    5154:	d01ff0ef          	jal	4e54 <putc>
    5158:	8bca                	mv	s7,s2
      state = 0;
    515a:	4981                	li	s3,0
    515c:	bbf5                	j	4f58 <vprintf+0x4a>
        if((s = va_arg(ap, char*)) == 0)
    515e:	008b8993          	addi	s3,s7,8
    5162:	000bb903          	ld	s2,0(s7)
    5166:	00090f63          	beqz	s2,5184 <vprintf+0x276>
        for(; *s; s++)
    516a:	00094583          	lbu	a1,0(s2)
    516e:	c195                	beqz	a1,5192 <vprintf+0x284>
          putc(fd, *s);
    5170:	855a                	mv	a0,s6
    5172:	ce3ff0ef          	jal	4e54 <putc>
        for(; *s; s++)
    5176:	0905                	addi	s2,s2,1
    5178:	00094583          	lbu	a1,0(s2)
    517c:	f9f5                	bnez	a1,5170 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    517e:	8bce                	mv	s7,s3
      state = 0;
    5180:	4981                	li	s3,0
    5182:	bbd9                	j	4f58 <vprintf+0x4a>
          s = "(null)";
    5184:	00002917          	auipc	s2,0x2
    5188:	78490913          	addi	s2,s2,1924 # 7908 <malloc+0x2678>
        for(; *s; s++)
    518c:	02800593          	li	a1,40
    5190:	b7c5                	j	5170 <vprintf+0x262>
        if((s = va_arg(ap, char*)) == 0)
    5192:	8bce                	mv	s7,s3
      state = 0;
    5194:	4981                	li	s3,0
    5196:	b3c9                	j	4f58 <vprintf+0x4a>
    5198:	64a6                	ld	s1,72(sp)
    519a:	79e2                	ld	s3,56(sp)
    519c:	7a42                	ld	s4,48(sp)
    519e:	7aa2                	ld	s5,40(sp)
    51a0:	7b02                	ld	s6,32(sp)
    51a2:	6be2                	ld	s7,24(sp)
    51a4:	6c42                	ld	s8,16(sp)
    51a6:	6ca2                	ld	s9,8(sp)
    }
  }
}
    51a8:	60e6                	ld	ra,88(sp)
    51aa:	6446                	ld	s0,80(sp)
    51ac:	6906                	ld	s2,64(sp)
    51ae:	6125                	addi	sp,sp,96
    51b0:	8082                	ret

00000000000051b2 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    51b2:	715d                	addi	sp,sp,-80
    51b4:	ec06                	sd	ra,24(sp)
    51b6:	e822                	sd	s0,16(sp)
    51b8:	1000                	addi	s0,sp,32
    51ba:	e010                	sd	a2,0(s0)
    51bc:	e414                	sd	a3,8(s0)
    51be:	e818                	sd	a4,16(s0)
    51c0:	ec1c                	sd	a5,24(s0)
    51c2:	03043023          	sd	a6,32(s0)
    51c6:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    51ca:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    51ce:	8622                	mv	a2,s0
    51d0:	d3fff0ef          	jal	4f0e <vprintf>
}
    51d4:	60e2                	ld	ra,24(sp)
    51d6:	6442                	ld	s0,16(sp)
    51d8:	6161                	addi	sp,sp,80
    51da:	8082                	ret

00000000000051dc <printf>:

void
printf(const char *fmt, ...)
{
    51dc:	711d                	addi	sp,sp,-96
    51de:	ec06                	sd	ra,24(sp)
    51e0:	e822                	sd	s0,16(sp)
    51e2:	1000                	addi	s0,sp,32
    51e4:	e40c                	sd	a1,8(s0)
    51e6:	e810                	sd	a2,16(s0)
    51e8:	ec14                	sd	a3,24(s0)
    51ea:	f018                	sd	a4,32(s0)
    51ec:	f41c                	sd	a5,40(s0)
    51ee:	03043823          	sd	a6,48(s0)
    51f2:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    51f6:	00840613          	addi	a2,s0,8
    51fa:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    51fe:	85aa                	mv	a1,a0
    5200:	4505                	li	a0,1
    5202:	d0dff0ef          	jal	4f0e <vprintf>
}
    5206:	60e2                	ld	ra,24(sp)
    5208:	6442                	ld	s0,16(sp)
    520a:	6125                	addi	sp,sp,96
    520c:	8082                	ret

000000000000520e <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    ...
    5210:	e422                	sd	s0,8(sp)
    5212:	0800                	addi	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5214:	ff050693          	addi	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5218:	00003797          	auipc	a5,0x3
    521c:	2787b783          	ld	a5,632(a5) # 8490 <freep>
    5220:	a02d                	j	524a <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5222:	4618                	lw	a4,8(a2)
    5224:	9f2d                	addw	a4,a4,a1
    5226:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    522a:	6398                	ld	a4,0(a5)
    522c:	6310                	ld	a2,0(a4)
    522e:	a83d                	j	526c <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5230:	ff852703          	lw	a4,-8(a0)
    5234:	9f31                	addw	a4,a4,a2
    5236:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5238:	ff053683          	ld	a3,-16(a0)
    523c:	a091                	j	5280 <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    523e:	6398                	ld	a4,0(a5)
    5240:	00e7e463          	bltu	a5,a4,5248 <free+0x3a>
    5244:	00e6ea63          	bltu	a3,a4,5258 <free+0x4a>
{
    5248:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    524a:	fed7fae3          	bgeu	a5,a3,523e <free+0x30>
    524e:	6398                	ld	a4,0(a5)
    5250:	00e6e463          	bltu	a3,a4,5258 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5254:	fee7eae3          	bltu	a5,a4,5248 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5258:	ff852583          	lw	a1,-8(a0)
    525c:	6390                	ld	a2,0(a5)
    525e:	02059813          	slli	a6,a1,0x20
    5262:	01c85713          	srli	a4,a6,0x1c
    5266:	9736                	add	a4,a4,a3
    5268:	fae60de3          	beq	a2,a4,5222 <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    526c:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5270:	4790                	lw	a2,8(a5)
    5272:	02061593          	slli	a1,a2,0x20
    5276:	01c5d713          	srli	a4,a1,0x1c
    527a:	973e                	add	a4,a4,a5
    527c:	fae68ae3          	beq	a3,a4,5230 <free+0x22>
    p->s.ptr = bp->s.ptr;
    5280:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5282:	00003717          	auipc	a4,0x3
    5286:	20f73723          	sd	a5,526(a4) # 8490 <freep>
}
    528a:	6422                	ld	s0,8(sp)
    528c:	0141                	addi	sp,sp,16
    528e:	8082                	ret

0000000000005290 <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5290:	7139                	addi	sp,sp,-64
    5292:	fc06                	sd	ra,56(sp)
    5294:	f822                	sd	s0,48(sp)
    5296:	f426                	sd	s1,40(sp)
    5298:	ec4e                	sd	s3,24(sp)
    529a:	0080                	addi	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    529c:	02051493          	slli	s1,a0,0x20
    52a0:	9081                	srli	s1,s1,0x20
    52a2:	04bd                	addi	s1,s1,15
    52a4:	8091                	srli	s1,s1,0x4
    52a6:	0014899b          	addiw	s3,s1,1
    52aa:	0485                	addi	s1,s1,1
  if((prevp = freep) == 0){
    52ac:	00003517          	auipc	a0,0x3
    52b0:	1e453503          	ld	a0,484(a0) # 8490 <freep>
    52b4:	c915                	beqz	a0,52e8 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    52b6:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    52b8:	4798                	lw	a4,8(a5)
    52ba:	08977a63          	bgeu	a4,s1,534e <malloc+0xbe>
  ...
  if(nu < 4096)
    52c6:	8a4e                	mv	s4,s3
    52c8:	0009871b          	sext.w	a4,s3
    52cc:	6685                	lui	a3,0x1
    52ce:	00d77363          	bgeu	a4,a3,52d4 <malloc+0x44>
    52d2:	6a05                	lui	s4,0x1
    52d4:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    52d8:	004a1a1b          	slliw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    52dc:	00003917          	auipc	s2,0x3
    52e0:	1b490913          	addi	s2,s2,436 # 8490 <freep>
  if(p == SBRK_ERROR)
    52e4:	5afd                	li	s5,-1
    52e6:	a081                	j	5326 <malloc+0x96>
    52e8:	f04a                	sd	s2,32(sp)
    52ea:	e852                	sd	s4,16(sp)
    52ec:	e456                	sd	s5,8(sp)
    52ee:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    52f0:	0000a797          	auipc	a5,0xa
    52f4:	9c878793          	addi	a5,a5,-1592 # ecb8 <base>
    52f8:	00003717          	auipc	a4,0x3
    52fc:	18f73c23          	sd	a5,408(a4) # 8490 <freep>
    5300:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5302:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5306:	b7c1                	j	52c6 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    5308:	6398                	ld	a4,0(a5)
    530a:	e118                	sd	a4,0(a0)
    530c:	a8a9                	j	5366 <malloc+0xd6>
  hp->s.size = nu;
    530e:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5312:	0541                	addi	a0,a0,16
    5314:	efbff0ef          	jal	520e <free>
  return freep;
    5318:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    531c:	c12d                	beqz	a0,537e <malloc+0xee>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    531e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5320:	4798                	lw	a4,8(a5)
    5322:	02977263          	bgeu	a4,s1,5346 <malloc+0xb6>
    if(p == freep)
    5326:	00093703          	ld	a4,0(s2)
    532a:	853e                	mv	a0,a5
    532c:	fef719e3          	bne	a4,a5,531e <malloc+0x8e>
  p = sbrk(nu * sizeof(Header));
    5330:	8552                	mv	a0,s4
    5332:	a0fff0ef          	jal	4d40 <sbrk>
  if(p == SBRK_ERROR)
    5336:	fd551ce3          	bne	a0,s5,530e <malloc+0x7e>
        return 0;
    533a:	4501                	li	a0,0
    533c:	7902                	ld	s2,32(sp)
    533e:	6a42                	ld	s4,16(sp)
    5340:	6aa2                	ld	s5,8(sp)
    5342:	6b02                	ld	s6,0(sp)
    5344:	a03d                	j	5372 <malloc+0xe2>
    5346:	7902                	ld	s2,32(sp)
    5348:	6a42                	ld	s4,16(sp)
    534a:	6aa2                	ld	s5,8(sp)
    534c:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    534e:	fae48de3          	beq	s1,a4,5308 <malloc+0x78>
        p->s.size -= nunits;
    5352:	4137073b          	subw	a4,a4,s3
    5356:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5358:	02071693          	slli	a3,a4,0x20
    535c:	01c6d713          	srli	a4,a3,0x1c
    5360:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5362:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5366:	00003717          	auipc	a4,0x3
    536a:	12a73523          	sd	a0,298(a4) # 8490 <freep>
      return (void*)(p + 1);
    536e:	01078513          	addi	a0,a5,16
  }
}
